<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
    ...
    <symbols>
      <symbol alpha="1" name="0" outputUnit="MM" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
          <prop k="color" v="155,201,207,255" />
  ...
  <customproperties />
  <displayfield>ebene</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype name="bemerkung" type="0" />
    <edittype name="ebene" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="lieferdatum" type="0" />
    <edittype name="los" type="0" />
    <edittype name="ogc_fid" type="0" />
  </edittypes>
  <editform>/usr/share/qgis/python/plugins/soverify/dm01avbe11d/defects/maengelForm.ui</editform>
  <editforminit>soverify.dm01avbe11d.defects.maengelFormInit</editforminit>
  <annotationform />
  <attributeactions />
