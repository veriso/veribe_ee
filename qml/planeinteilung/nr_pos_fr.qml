<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="planpos_von">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="ori" name="Ori" index="2" />
    <alias field="hali" name="HAli" index="3" />
    <alias field="hali_txt" name="HAli_txt" index="4" />
    <alias field="vali" name="VAli" index="5" />
    <alias field="vali_txt" name="VAli_txt" index="6" />
    <alias field="groesse" name="Grandeur" index="7" />
    <alias field="groesse_txt" name="Grandeur_txt" index="8" />
    <alias field="planpos_von" name="Posplan_de" index="9" />
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="planpos_von" expression="" />
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" field="planpos_von" constraints="1" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="planpos_von" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="planpos_von" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="planpos_von" />
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="planpos_von" />
