<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol clip_to_extent="1" alpha="0.52" type="fill" force_rhr="0" name="0">
        ...
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="248,246,183,255" />
            <Option type="QString" name="joinstyle" value="bevel" />
            <Option type="QString" name="offset" value="0,0" />
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" />
            <Option type="QString" name="offset_unit" value="MM" />
            <Option type="QString" name="outline_color" value="236,41,24,255" />
          ...
          <prop k="color" v="248,246,183,255" />
          <prop k="joinstyle" v="bevel" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="236,41,24,255" />
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="1" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="0,0,0,255" fontSize="12">
        <families />
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="gemeindegrenze_von" expression="" />
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" field="gemeindegrenze_von" constraints="1" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="ogc_fid" />
    <constraint exp="" desc="" field="t_ili_tid" />
    <constraint exp="" desc="" field="entstehung" />
    <constraint exp="" desc="" field="gemeindegrenze_von" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="gemeindegrenze_von" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="gemeindegrenze_von" />
    <field editable="1" name="ogc_fid" />
    <field editable="1" name="t_ili_tid" />
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="entstehung" />
    <field labelOnTop="0" name="gemeindegrenze_von" />
