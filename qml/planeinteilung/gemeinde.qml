...
<qgis labelsEnabled="1" simplifyDrawingHints="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.4-Madeira" maxScale="0" minScale="1e+8" readOnly="0">
 ...
 <renderer-v2 forceraster="0" enableorderby="0" type="singleSymbol" symbollevels="0">
  <symbols>
   <symbol alpha="0.52" name="0" type="fill" clip_to_extent="1" force_rhr="0">
 ...
 <labeling type="simple">
  <settings>
   <text-style namedStyle="" blendMode="0" fontSizeUnit="Point" previewBkgrdColor="#ffffff" fontLetterSpacing="0" textColor="0,0,0,255" fontStrikeout="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" textOpacity="1" useSubstitutions="0" fontUnderline="0" fontCapitals="0" fontWeight="50" isExpression="1" fieldName="" fontSize="12" fontFamily="Sans" fontWordSpacing="0">
 ...
 <constraints>
  ...
  <constraint field="gemeindegrenze_von" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
 </constraints>
 ...
 <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
  <columns>
   ...
   <column name="gemeindegrenze_von" type="field" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
 ...
 <labelOnTop>
  ...
  <field name="gemeindegrenze_von" labelOnTop="0"/>
