<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Stein' " label="Stein" symbol="0" />
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Kunststoffzeichen'" label="Kunststoffzeichen" symbol="1" />
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Bolzen' " label="Bolzen" symbol="2" />
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Rohr' " label="Rohr" symbol="3" />
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Pfahl'" label="Pfahl" symbol="4" />
      <rule filter=" &quot;punktzeichen_txt&quot; =   'Kreuz' " label="Kreuz" symbol="5" />
      <rule filter=" &quot;punktzeichen_txt&quot; NOT IN ('Bolzen' , 'Kreuz' , 'Rohr' , 'Stein' )" label="andere " symbol="6" />
    </rules>
    <symbols>
