<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" version="1.7.0-Trunk">
  ...
  <displayfield>punktname</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype name="e95" type="0" />
    <edittype name="gid" type="0" />
    <edittype name="h02" type="0" />
    <edittype name="h95_ell" type="0" />
    <edittype name="n95" type="0" />
    <edittype name="nummer" type="0" />
    <edittype name="ordnung" type="0" />
    <edittype name="punktname" type="0" />
    <edittype name="statuszus" type="0" />
    <edittype name="url" type="0" />
    <edittype name="x03" type="0" />
    <edittype name="y03" type="0" />
    <edittype name="zugang" type="0" />
    <edittype name="zust_haupt" type="0" />
  </edittypes>
  <editform />
  <editforminit />
  <annotationform />
