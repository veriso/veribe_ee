<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="lagegen" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range label="0!" lower="0" symbol="0" upper="0.0001" />
      <range label="&lt;=1" lower="0.0001" symbol="1" upper="1" />
      <range label="&lt;=2" lower="1.0001" symbol="2" upper="2" />
      <range label="&lt;=4" lower="2.0001" symbol="3" upper="4" />
      <range label="&gt;4" lower="4.0001" symbol="4" upper="1000" />
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" name="1" outputUnit="MM" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="2" outputUnit="MM" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="3" outputUnit="MM" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="4" outputUnit="MM" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
    ...
    <source-symbol>
      <symbol alpha="1" name="0" outputUnit="MM" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
          <prop k="color" v="194,227,156,255" />
  ...
  <edittypes>
    <edittype name="begehbarkeit" type="0" />
    <edittype name="begehbarkeit_txt" type="0" />
