<qgis simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" simplifyDrawingHints="0" labelsEnabled="1" maxScale="0" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <renderer-v2 referencescale="-1" forceraster="0" type="categorizedSymbol" enableorderby="0" attr="punktzeichen_txt" symbollevels="0">
    <categories>
      <category symbol="0" label="" render="true" value="" />
      <category symbol="1" label="Bolzen" render="true" value="Bolzen" />
      <category symbol="2" label="Kreuz" render="true" value="Kreuz" />
      <category symbol="3" label="Rohr" render="true" value="Rohr" />
      <category symbol="4" label="Stein" render="true" value="Stein" />
    </categories>
    <symbols>
      <symbol alpha="1" type="marker" name="0" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="177,163,128,255" />
          ...
          <prop v="177,163,128,255" k="color" />
      ...
      <symbol alpha="1" type="marker" name="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="horizontal_anchor_point" value="1" />
            <Option type="QString" name="name" value="symbol/blue-marker.svg" />
            <Option type="QString" name="offset" value="0,0" />
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" />
            <Option type="QString" name="offset_unit" value="MM" />
            <Option type="QString" name="outline_color" value="0,0,0,255" />
          ...
          <prop v="1" k="horizontal_anchor_point" />
          <prop v="symbol/blue-marker.svg" k="name" />
          <prop v="0,0" k="offset" />
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale" />
          <prop v="MM" k="offset_unit" />
          <prop v="0,0,0,255" k="outline_color" />
      ...
      <symbol alpha="1" type="marker" name="2" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="QString" name="fixedAspectRatio" value="0" />
            <Option type="QString" name="horizontal_anchor_point" value="1" />
            <Option type="QString" name="name" value="landmark/religion=christian.svg" />
            <Option type="QString" name="offset" value="0,0" />
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" />
            <Option type="QString" name="offset_unit" value="MM" />
            <Option type="QString" name="outline_color" value="0,0,0,255" />
      ...
      <symbol alpha="1" type="marker" name="3" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop v="0" k="fixedAspectRatio" />
          <prop v="1" k="horizontal_anchor_point" />
          <prop v="transport/barrier_bollard.svg" k="name" />
          <prop v="0,0" k="offset" />
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale" />
          <prop v="MM" k="offset_unit" />
          <prop v="0,0,0,255" k="outline_color" />
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="labeling/drawLabels" value="false" />
  ...
  <DiagramLayerSettings zIndex="0" obstacle="0" linePlacementFlags="10" dist="0" priority="0" showAll="1" placement="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value="" />
        <Option name="properties" />
  ...
  <fieldConfiguration>
    ...
    <field name="hoehegeom" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="lagegen" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="lagezuv" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="lagezuv_txt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="hoehegen" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="hoehezuv" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="hoehezuv_txt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="punktzeichen" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="punktzeichen_txt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="protokoll" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="protokoll_txt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias index="2" name="NBIdent" field="nbident" />
    <alias index="3" name="Nummer" field="nummer" />
    <alias index="4" name="HoeheGeom" field="hoehegeom" />
    <alias index="5" name="LageGen" field="lagegen" />
    <alias index="6" name="LageZuv" field="lagezuv" />
    <alias index="7" name="LageZuv_txt" field="lagezuv_txt" />
    <alias index="8" name="HoeheGen" field="hoehegen" />
    <alias index="9" name="HoeheZuv" field="hoehezuv" />
    <alias index="10" name="HoeheZuv_txt" field="hoehezuv_txt" />
    <alias index="11" name="Punktzeichen" field="punktzeichen" />
    <alias index="12" name="Punktzeichen_txt" field="punktzeichen_txt" />
    <alias index="13" name="Protokoll" field="protokoll" />
    <alias index="14" name="Protokoll_txt" field="protokoll_txt" />
    <alias index="15" name="Entstehung" field="entstehung" />
  </aliases>
  <defaults>
    ...
    <default field="hoehegeom" expression="" applyOnUpdate="0" />
    ...
    <default field="hoehegen" expression="" applyOnUpdate="0" />
    <default field="hoehezuv" expression="" applyOnUpdate="0" />
    <default field="hoehezuv_txt" expression="" applyOnUpdate="0" />
    <default field="punktzeichen" expression="" applyOnUpdate="0" />
    <default field="punktzeichen_txt" expression="" applyOnUpdate="0" />
    <default field="protokoll" expression="" applyOnUpdate="0" />
    <default field="protokoll_txt" expression="" applyOnUpdate="0" />
  ...
  <constraints>
    ...
    <constraint constraints="1" field="nbident" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="1" field="nummer" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="0" field="hoehegeom" unique_strength="0" notnull_strength="0" exp_strength="0" />
    <constraint constraints="1" field="lagegen" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="1" field="lagezuv" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="1" field="lagezuv_txt" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="0" field="hoehegen" unique_strength="0" notnull_strength="0" exp_strength="0" />
    <constraint constraints="0" field="hoehezuv" unique_strength="0" notnull_strength="0" exp_strength="0" />
    <constraint constraints="0" field="hoehezuv_txt" unique_strength="0" notnull_strength="0" exp_strength="0" />
    <constraint constraints="1" field="punktzeichen" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="1" field="punktzeichen_txt" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="1" field="protokoll" unique_strength="0" notnull_strength="1" exp_strength="0" />
    <constraint constraints="1" field="protokoll_txt" unique_strength="0" notnull_strength="1" exp_strength="0" />
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="nbident" exp="" />
    <constraint desc="" field="nummer" exp="" />
    <constraint desc="" field="hoehegeom" exp="" />
    <constraint desc="" field="lagegen" exp="" />
    <constraint desc="" field="lagezuv" exp="" />
    <constraint desc="" field="lagezuv_txt" exp="" />
    <constraint desc="" field="hoehegen" exp="" />
    <constraint desc="" field="hoehezuv" exp="" />
    <constraint desc="" field="hoehezuv_txt" exp="" />
    <constraint desc="" field="punktzeichen" exp="" />
    <constraint desc="" field="punktzeichen_txt" exp="" />
    <constraint desc="" field="protokoll" exp="" />
    <constraint desc="" field="protokoll_txt" exp="" />
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="hoehegeom" />
      <column width="-1" hidden="0" type="field" name="lagegen" />
      <column width="-1" hidden="0" type="field" name="lagezuv" />
      <column width="-1" hidden="0" type="field" name="lagezuv_txt" />
      <column width="-1" hidden="0" type="field" name="hoehegen" />
      <column width="-1" hidden="0" type="field" name="hoehezuv" />
      <column width="-1" hidden="0" type="field" name="hoehezuv_txt" />
      <column width="-1" hidden="0" type="field" name="punktzeichen" />
      <column width="-1" hidden="0" type="field" name="punktzeichen_txt" />
      <column width="-1" hidden="0" type="field" name="protokoll" />
      <column width="-1" hidden="0" type="field" name="protokoll_txt" />
