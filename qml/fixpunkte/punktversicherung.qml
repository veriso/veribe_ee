...
<qgis simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" simplifyDrawingHints="0" labelsEnabled="1" maxScale="0" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <aliases>
    ...
    <alias index="2" name="" field="nbident"/>
    <alias index="3" name="" field="nummer"/>
    <alias index="4" name="" field="hoehegeom"/>
    <alias index="5" name="" field="lagegen"/>
    <alias index="6" name="" field="lagezuv"/>
    <alias index="7" name="" field="lagezuv_txt"/>
    <alias index="8" name="" field="hoehegen"/>
    <alias index="9" name="" field="hoehezuv"/>
    <alias index="10" name="" field="hoehezuv_txt"/>
    <alias index="11" name="" field="punktzeichen"/>
    <alias index="12" name="" field="punktzeichen_txt"/>
    <alias index="13" name="" field="protokoll"/>
    <alias index="14" name="" field="protokoll_txt"/>
    <alias index="15" name="" field="entstehung"/>
  </aliases>
  <defaults>
