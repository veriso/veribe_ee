<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.6">
  <edittypes>
    ...
    <edittype name="hoehegeom" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="lagegen" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="lagezuv" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="lagezuv_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="hoehegen" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="hoehezuv" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="hoehezuv_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    ...
    <edittype name="protokoll" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="protokoll_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
  ...
  <aliases>
    ...
    <alias field="punktzeichen" index="11" name="" />
    <alias field="punktzeichen_txt" index="12" name="" />
    <alias field="protokoll" index="13" name="" />
    <alias field="protokoll_txt" index="14" name="" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="hoehegeom" type="field" width="-1" />
      <column hidden="0" name="lagegen" type="field" width="-1" />
      <column hidden="0" name="lagezuv" type="field" width="-1" />
      <column hidden="0" name="lagezuv_txt" type="field" width="-1" />
      <column hidden="0" name="hoehegen" type="field" width="-1" />
      <column hidden="0" name="hoehezuv" type="field" width="-1" />
      <column hidden="0" name="hoehezuv_txt" type="field" width="-1" />
      <column hidden="0" name="punktzeichen" type="field" width="-1" />
      <column hidden="0" name="punktzeichen_txt" type="field" width="-1" />
      <column hidden="0" name="protokoll" type="field" width="-1" />
      <column hidden="0" name="protokoll_txt" type="field" width="-1" />
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default expression="" field="hoehegeom" />
    <default expression="" field="lagegen" />
    <default expression="" field="lagezuv" />
    <default expression="" field="lagezuv_txt" />
    <default expression="" field="hoehegen" />
    <default expression="" field="hoehezuv" />
    <default expression="" field="hoehezuv_txt" />
    <default expression="" field="punktzeichen" />
    <default expression="" field="punktzeichen_txt" />
    <default expression="" field="protokoll" />
    <default expression="" field="protokoll_txt" />
    <default expression="" field="entstehung" />
  </defaults>
  <previewExpression />
