...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Białowieża" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="nbident" name="" index="2"/>
    <alias field="nummer" name="" index="3"/>
    <alias field="hoehegeom" name="" index="4"/>
    <alias field="lagegen" name="" index="5"/>
    <alias field="lagezuv" name="" index="6"/>
    <alias field="lagezuv_txt" name="" index="7"/>
    <alias field="hoehegen" name="" index="8"/>
    <alias field="hoehezuv" name="" index="9"/>
    <alias field="hoehezuv_txt" name="" index="10"/>
    <alias field="punktzeichen" name="" index="11"/>
    <alias field="punktzeichen_txt" name="" index="12"/>
    <alias field="protokoll" name="" index="13"/>
    <alias field="protokoll_txt" name="" index="14"/>
    <alias field="entstehung" name="" index="15"/>
  </aliases>
  <defaults>
