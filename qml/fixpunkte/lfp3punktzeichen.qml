...
<qgis version="2.5.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="punktzeichen_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="Bolzen" label="Bolzen"/>
      <category render="true" symbol="1" value="Rohr" label="Rohr"/>
      <category render="true" symbol="2" value="Stein" label="Stein"/>
      <category render="true" symbol="3" value="Kreuz" label="Kreuz"/>
