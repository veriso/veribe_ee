<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
  ...
  <renderer-v2 attr="punktzeichen_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Bolzen" render="true" symbol="0" value="Bolzen" />
      <category label="Rohr" render="true" symbol="1" value="Rohr" />
      <category label="Stein" render="true" symbol="2" value="Stein" />
      <category label="Kreuz" render="true" symbol="3" value="Kreuz" />
    ...
    <symbols>
      ...
      <symbol alpha="1" name="1" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="#000000" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="grundbuchplan/symbol_L_lagefixpunkt_3_auf_rohr_pfahl.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="#000000" />
      ...
      <symbol alpha="1" name="3" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="#000000" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="grundbuchplan/symbol_M_lagefixpunkt_3_auf_kreuz.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="#000000" />
