...
<qgis version="2.5.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="protokoll_txt">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="punktzeichen_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="1" value="Bolzen" label="Bolzen"/>
      <category render="true" symbol="2" value="Kreuz" label="Kreuz"/>
      <category render="true" symbol="3" value="Rohr" label="Rohr"/>
      <category render="true" symbol="4" value="Stein" label="Stein"/>
    </categories>
    <symbols>
