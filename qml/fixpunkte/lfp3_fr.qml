<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="-4.65661e-10" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Stein' " label="borne" symbol="0" />
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Kunststoffzeichen'" label="borne artificielle " symbol="1" />
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Bolzen' " label="cheville" symbol="2" />
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Rohr' " label="tuyau" symbol="3" />
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Pfahl'" label="pieu" symbol="4" />
      <rule filter=" &quot;punktzeichen_txt&quot; =   'Kreuz' " label="croix" symbol="5" />
      <rule filter=" &quot;punktzeichen_txt&quot; NOT IN ('Bolzen' , 'Kreuz' , 'Rohr' , 'Stein' )" label="autre" symbol="6" />
    </rules>
    <symbols>
