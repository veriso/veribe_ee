<qgis labelsEnabled="1" simplifyDrawingHints="1" maxScale="0" minScale="100000000" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1" version="3.22.10-Bia&#322;owie&#380;a">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0">
    <rules key="{791b72da-9f30-42e8-be49-674f2acf6843}">
      <rule label="uebriger_Gebaeudeteil" key="{4b52d3df-f970-4b2d-a150-8350a6f30b1b}" filter=" &quot;art_txt&quot; LIKE 'uebriger_Gebaeudeteil%'" symbol="0" />
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="linienelement_von" index="2" name="Linienelement_von" />
    <alias field="art" index="3" name="Art" />
    <alias field="art_txt" index="4" name="Art_txt" />
  ...
  <constraints>
    ...
    <constraint field="linienelement_von" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" />
  ...
  <constraintExpressions>
    ...
    <constraint field="linienelement_von" exp="" desc="" />
