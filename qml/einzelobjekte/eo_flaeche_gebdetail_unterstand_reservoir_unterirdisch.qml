<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;art_txt&quot; LIKE  'unterirdisches_Gebaeude%' " label="unterirdisches_Gebaeude" symbol="0" />
      <rule filter=" &quot;art_txt&quot; LIKE 'uebriger_Gebaeudeteil%'" label="uebriger_Gebaeudeteil" symbol="1" />
      <rule filter=" &quot;art_txt&quot; LIKE 'Reservoir%'" label="Reservoir" symbol="2" />
      <rule filter=" &quot;art_txt&quot; LIKE 'Unterstand%'" label="Unterstand" symbol="3" />
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="fill">
        <layer class="PointPatternFill" locked="0" pass="0">
          ...
          <symbol alpha="1" name="@0@0" type="marker">
      ...
      <symbol alpha="1" name="2" type="fill">
        <layer class="PointPatternFill" locked="0" pass="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0" />
          <prop k="outline_width_unit" v="MM" />
          <symbol alpha="1" name="@2@0" type="marker">
            <layer class="SimpleMarker" locked="0" pass="0">
              <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="3" type="fill">
        <layer class="LinePatternFill" locked="0" pass="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0" />
          <prop k="outline_width_unit" v="MM" />
          <symbol alpha="1" name="@3@0" type="line">
            <layer class="SimpleLine" locked="0" pass="0">
