<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.22.10-Bia&#322;owie&#380;a" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{02146973-c3ab-4816-9df2-f535cb5b5940}">
      <rule label="batiment_souterrain" key="{02ba2da4-3f74-4a10-9fb1-a65cc4c54614}" filter=" &quot;art_txt&quot; LIKE  'unterirdisches_Gebaeude%' " symbol="0" />
      <rule label="autre_corps_de_batiment" key="{8658d6cd-a3d1-4e93-8d7e-0815cb05236f}" filter=" &quot;art_txt&quot; LIKE 'uebriger_Gebaeudeteil%'" symbol="1" />
      <rule label="reservoir" key="{bfa83cbe-ac65-4aca-a316-8c71a37a6e9d}" filter=" &quot;art_txt&quot; LIKE 'Reservoir%'" symbol="2" />
      <rule label="couvert_independant" key="{cb918832-9e5d-4d7a-a167-d8fbe5c6980b}" filter=" &quot;art_txt&quot; LIKE 'Unterstand%'" symbol="3" />
    </rules>
    <symbols>
      ...
      <symbol type="fill" name="3" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="LinePatternFill" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="distance" value="1.5" />
  ...
  <fieldConfiguration>
    ...
    <field name="eo_tid" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="flaechenelement_von" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="art" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="art_txt" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="eo_tid" exp_strength="0" notnull_strength="0" unique_strength="0" />
  </constraints>
