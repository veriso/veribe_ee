<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.22.10-Bia&#322;owie&#380;a" simplifyDrawingTol="1" maxScale="-4.6566099999999998e-10" labelsEnabled="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000">
      ...
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="0,192,0,255" />
          ...
          <prop k="line_color" v="0,192,0,255" />
  ...
  <fieldConfiguration>
    ...
    <field name="ordnung" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="istachse" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="istachse_txt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="strassenstueck_von" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="anfangspunkt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="ordnung" name="Ordnung" index="2" />
    <alias field="istachse" name="IstAchse" index="3" />
    <alias field="istachse_txt" name="IstAchse_txt" index="4" />
    <alias field="strassenstueck_von" name="Strassenstueck_von" index="5" />
    <alias field="anfangspunkt" name="Anfangspunkt" index="6" />
  </aliases>
  <defaults>
    <default expression="" field="ogc_fid" applyOnUpdate="0" />
    <default expression="" field="t_ili_tid" applyOnUpdate="0" />
    <default expression="" field="ordnung" applyOnUpdate="0" />
    <default expression="" field="istachse" applyOnUpdate="0" />
    <default expression="" field="istachse_txt" applyOnUpdate="0" />
    <default expression="" field="strassenstueck_von" applyOnUpdate="0" />
    <default expression="" field="anfangspunkt" applyOnUpdate="0" />
  </defaults>
  <constraints>
    ...
    <constraint constraints="1" field="ordnung" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" field="istachse" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" field="istachse_txt" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" field="strassenstueck_von" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="0" field="anfangspunkt" exp_strength="0" notnull_strength="0" unique_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint field="ogc_fid" exp="" desc="" />
    <constraint field="t_ili_tid" exp="" desc="" />
    <constraint field="ordnung" exp="" desc="" />
    <constraint field="istachse" exp="" desc="" />
    <constraint field="istachse_txt" exp="" desc="" />
    <constraint field="strassenstueck_von" exp="" desc="" />
    <constraint field="anfangspunkt" exp="" desc="" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions />
