<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.22.10-Bia&#322;owie&#380;a" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000">
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="labeling/dataDefined/Hali" value="1~~0~~~~art_txt" />
  ...
  <aliases>
    ...
    <alias field="flaeche" name="Flaeche" index="3" />
    <alias field="qualitaet" name="Qualitaet" index="4" />
    <alias field="qualitaet_txt" name="Qualitaet_txt" index="5" />
    <alias field="art" name="Art" index="6" />
    <alias field="art_txt" name="Art_txt" index="7" />
  </aliases>
  <defaults>
    <default expression="" field="ogc_fid" applyOnUpdate="0" />
    <default expression="" field="tid" applyOnUpdate="0" />
  ...
  <constraints>
    ...
    <constraint constraints="0" field="tid" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="entstehung" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="flaeche" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="qualitaet" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="qualitaet_txt" exp_strength="0" notnull_strength="0" unique_strength="0" />
