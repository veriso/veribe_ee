<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
      ...
      <symbol clip_to_extent="1" alpha="1" type="fill" force_rhr="0" name="0">
        ...
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="139,84,36,255" />
            <Option type="QString" name="joinstyle" value="bevel" />
            <Option type="QString" name="offset" value="0,0" />
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" />
            <Option type="QString" name="offset_unit" value="MM" />
            <Option type="QString" name="outline_color" value="0,150,0,255" />
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="plz" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="Normal" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans Serif" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="0,150,0,255" fontSize="16">
        <families />
      ...
      <placement offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" quadOffset="7" placementFlags="10" fitInPolygonOnly="0" geometryGeneratorEnabled="0" overrunDistance="0" centroidWhole="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" preserveRotation="1" repeatDistanceUnits="MM" polygonPlacementFlags="2" overrunDistanceUnit="MM" yOffset="0" dist="1" priority="5" distUnits="Point" placement="0" maxCurvedCharAngleIn="25" repeatDistance="0" geometryGenerator="" xOffset="0" lineAnchorPercent="0.5" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" rotationAngle="0" layerType="UnknownGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" />
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="zusatzziffern">
      <editWidget type="Range">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="plz6_von">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="plz" name="NPA" index="6" />
    <alias field="zusatzziffern" name="Chiffres_supplementaires" index="7" />
    <alias field="entstehung" name="Origine" index="8" />
    <alias field="plz6_von" name="NPA6_de" index="9" />
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="zusatzziffern" expression="" />
    <default applyOnUpdate="0" field="entstehung" expression="" />
    <default applyOnUpdate="0" field="plz6_von" expression="" />
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" field="plz" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="zusatzziffern" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="entstehung" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="plz6_von" constraints="1" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="zusatzziffern" />
    <constraint exp="" desc="" field="entstehung" />
    <constraint exp="" desc="" field="plz6_von" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="zusatzziffern" />
      <column width="-1" hidden="0" type="field" name="entstehung" />
      <column width="-1" hidden="0" type="field" name="plz6_von" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="plz6_von" />
    <field editable="1" name="status" />
    <field editable="1" name="status_txt" />
    <field editable="1" name="t_ili_tid" />
    <field editable="1" name="zusatzziffern" />
  </editable>
  <labelOnTop>
