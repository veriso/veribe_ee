<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.22.10-Bia&#322;owie&#380;a" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000">
      ...
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="66,66,250,255" />
          ...
          <prop k="line_color" v="66,66,250,255" />
  ...
  <fieldConfiguration>
    ...
    <field name="strname" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="a_tid" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="b_tid" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="strname" name="" index="1" />
    <alias field="hausnummer" name="Hausnummer" index="2" />
    <alias field="a_tid" name="" index="3" />
    <alias field="b_tid" name="" index="4" />
    <alias field="lok_tid" name="" index="5" />
  </aliases>
  <defaults>
    <default expression="" field="ogc_fid" applyOnUpdate="0" />
    <default expression="" field="strname" applyOnUpdate="0" />
    <default expression="" field="hausnummer" applyOnUpdate="0" />
    <default expression="" field="a_tid" applyOnUpdate="0" />
    <default expression="" field="b_tid" applyOnUpdate="0" />
  ...
  <constraints>
    ...
    <constraint constraints="0" field="strname" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="hausnummer" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="a_tid" exp_strength="0" notnull_strength="0" unique_strength="0" />
    <constraint constraints="0" field="b_tid" exp_strength="0" notnull_strength="0" unique_strength="0" />
  ...
  <constraintExpressions>
    ...
    <constraint field="strname" exp="" desc="" />
    <constraint field="hausnummer" exp="" desc="" />
    <constraint field="a_tid" exp="" desc="" />
    <constraint field="b_tid" exp="" desc="" />
  ...
  <widgets />
  <previewExpression>"strname"</previewExpression>
  <mapTip />
