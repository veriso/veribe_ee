<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Bruecke_Passerelle" symbol="0" value="Bruecke_Passerelle" />
      <category label="Reservoir" symbol="1" value="Reservoir" />
      <category label="Aussichtsturm" symbol="2" value="Aussichtsturm" />
      <category label="Ruine" symbol="3" value="Ruine_archeologisches_Objekt" />
      <category label="uebriger_Gebaeudeteil" symbol="4" value="uebriger_Gebaeudeteil" />
      <category label="unterirdisches_Gebaeude" symbol="5" value="unterirdisches_Gebaeude" />
      <category label="Unterstand" symbol="6" value="Unterstand" />
    </categories>
    <symbols>
      <symbol alpha="0.552941" name="0" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="0,0,255,141" />
          <prop k="color_border" v="0,0,0,141" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="0.498039" name="1" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="255,41,87,127" />
      ...
      <symbol alpha="0.490196" name="2" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="85,170,0,125" />
      ...
      <symbol alpha="1" name="3" outputUnit="MM" type="fill">
      ...
      <symbol alpha="1" name="4" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
      ...
      <symbol alpha="1" name="5" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
      ...
      <symbol alpha="1" name="6" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
      ...
      <symbol alpha="1" name="@3@0" outputUnit="MM" type="marker">
