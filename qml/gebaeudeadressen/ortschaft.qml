<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="kurztext" name="KurzText" index="1" />
    <alias field="indextext" name="IndexText" index="2" />
    <alias field="sprache_txt" name="Sprache_txt" index="3" />
    <alias field="sprache" name="Sprache" index="4" />
    <alias field="status" name="Status" index="5" />
    <alias field="status_txt" name="Status_txt" index="6" />
    <alias field="ogc_fid" name="" index="7" />
    <alias field="inaenderung_txt" name="InAenderung_txt" index="8" />
    <alias field="inaenderung" name="InAenderung" index="9" />
  </aliases>
  <defaults>
