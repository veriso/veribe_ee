...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Białowieża" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="kurztext" name="" index="1"/>
    <alias field="indextext" name="" index="2"/>
    <alias field="sprache_txt" name="" index="3"/>
    <alias field="sprache" name="" index="4"/>
    <alias field="status" name="" index="5"/>
    <alias field="status_txt" name="" index="6"/>
    <alias field="ogc_fid" name="" index="7"/>
    <alias field="inaenderung_txt" name="" index="8"/>
    <alias field="inaenderung" name="" index="9"/>
  </aliases>
  <defaults>
