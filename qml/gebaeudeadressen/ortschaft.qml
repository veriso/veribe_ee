<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.11">
  <edittypes>
    <edittype name="atext" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="kurztext" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="indextext" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="sprache_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="sprache" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="status" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="status_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="ogc_fid" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="inaenderung_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="inaenderung" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
  </edittypes>
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="0.960784" clip_to_extent="1" name="0" type="fill">
  ...
  <label>1</label>
  <labelfield>atext</labelfield>
  <labelattributes>
    <label fieldname="atext" text="Beschriftung" />
    <family fieldname="" name="Ubuntu" />
    <size fieldname="" units="pt" value="16" />
    <bold fieldname="" on="0" />
    <italic fieldname="" on="0" />
    <underline fieldname="" on="0" />
    <strikeout fieldname="" on="0" />
    <color blue="0" fieldname="" green="148" red="222" />
    <x fieldname="" />
    <y fieldname="" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column hidden="0" name="atext" type="field" width="-1" />
      <column hidden="0" name="kurztext" type="field" width="-1" />
      <column hidden="0" name="indextext" type="field" width="-1" />
      <column hidden="0" name="sprache_txt" type="field" width="-1" />
      <column hidden="0" name="sprache" type="field" width="-1" />
      <column hidden="0" name="status" type="field" width="-1" />
      <column hidden="0" name="status_txt" type="field" width="-1" />
      <column hidden="0" name="ogc_fid" type="field" width="-1" />
      <column hidden="0" name="inaenderung_txt" type="field" width="-1" />
      <column hidden="0" name="inaenderung" type="field" width="-1" />
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default expression="" field="atext" />
    <default expression="" field="kurztext" />
    <default expression="" field="indextext" />
    <default expression="" field="sprache_txt" />
    <default expression="" field="sprache" />
    <default expression="" field="status" />
    <default expression="" field="status_txt" />
    <default expression="" field="ogc_fid" />
    <default expression="" field="inaenderung_txt" />
    <default expression="" field="inaenderung" />
  </defaults>
  <previewExpression />
  <layerGeometryType>2</layerGeometryType>
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="atext" fontCapitals="0" fontFamily="Ubuntu" fontItalic="0" fontLetterSpacing="0" fontSize="16" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="222,0,148" textOpacity="1" useSubstitutions="0">
