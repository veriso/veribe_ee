<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" version="1.7.0-Trunk">
  <transparencyLevelInt>255</transparencyLevelInt>
  <classificationattribute>inaenderung_txt</classificationattribute>
  <uniquevalue>
    <classificationfield>inaenderung_txt</classificationfield>
    <symbol>
      <lowervalue null="1" />
      <uppervalue null="1" />
      <label>Andere</label>
      ...
      <fillcolor blue="82" green="116" red="200" />
      <fillpattern>SolidPattern</fillpattern>
      <texturepath null="1" />
    </symbol>
    <symbol>
      <lowervalue>ja</lowervalue>
      ...
      <outlinestyle>SolidLine</outlinestyle>
      <outlinewidth>0.26</outlinewidth>
      <fillcolor blue="0" green="0" red="255" />
      <fillpattern>SolidPattern</fillpattern>
      <texturepath null="1" />
    </symbol>
    <symbol>
      <lowervalue>nein</lowervalue>
      <uppervalue>nein</uppervalue>
      <label />
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      ...
      <outlinestyle>SolidLine</outlinestyle>
      <outlinewidth>0.26</outlinewidth>
      <fillcolor blue="0" green="85" red="0" />
      <fillpattern>SolidPattern</fillpattern>
      <texturepath null="1" />
    </symbol>
  </uniquevalue>
  ...
  <labelattributes>
    ...
    <x fieldname="" />
    <y fieldname="" />
    <offset units="pt" x="2" xfieldname="" y="2" yfieldname="" />
  ...
  <edittypes>
    <edittype name="attributeprovisorisch" type="0" />
    <edittype name="attributeprovisorisch_txt" type="0" />
    <edittype name="entstehung" type="0" />
    <edittype name="gebaeudeeingang_von" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="gwr_edid" type="0" />
    <edittype name="gwr_egid" type="0" />
    <edittype name="hausnummer" type="0" />
    <edittype name="hoehenlage" type="0" />
    <edittype name="im_gebaeude" type="0" />
    <edittype name="im_gebaeude_txt" type="0" />
    <edittype name="inaenderung" type="0" />
    <edittype name="inaenderung_txt" type="0" />
    <edittype name="istoffiziellebezeichnung" type="0" />
    <edittype name="istoffiziellebezeichnung_txt" type="0" />
    <edittype name="lieferdatum" type="0" />
    <edittype name="los" type="0" />
    <edittype name="ogc_fid" type="0" />
    <edittype name="status" type="0" />
    <edittype name="status_txt" type="0" />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="hausnummer" fontCapitals="0" fontFamily="Droid Sans" fontItalic="0" fontLetterSpacing="0" fontSize="9" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="0,0,0" textOpacity="1" useSubstitutions="0">
