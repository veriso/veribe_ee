<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.22.10-Bia&#322;owie&#380;a" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000">
  ...
  <fieldConfiguration>
    ...
    <field name="benanntesgebiet_von" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="benanntesgebiet_von" name="BenanntesGebiet_von" index="2" />
  </aliases>
  <defaults>
    <default expression="" field="ogc_fid" applyOnUpdate="0" />
    <default expression="" field="t_ili_tid" applyOnUpdate="0" />
    <default expression="" field="benanntesgebiet_von" applyOnUpdate="0" />
  </defaults>
  <constraints>
    ...
    <constraint constraints="1" field="benanntesgebiet_von" exp_strength="0" notnull_strength="1" unique_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint field="ogc_fid" exp="" desc="" />
    <constraint field="t_ili_tid" exp="" desc="" />
    <constraint field="benanntesgebiet_von" exp="" desc="" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions />
