<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" version="1.7.0-Trunk">
  ...
  <singlesymbol>
    <symbol>
      ...
      <symbolfieldname />
      <outlinecolor blue="0" green="150" red="0" />
      <outlinestyle>SolidLine</outlinestyle>
      <outlinewidth>0.8</outlinewidth>
      <fillcolor blue="36" green="84" red="139" />
  ...
  <label>1</label>
  <labelfield>plz</labelfield>
  <labelattributes>
    <label fieldname="plz" text="Beschriftung" />
    ...
    <color blue="0" fieldname="" green="150" red="0" />
    <x fieldname="" />
    <y fieldname="" />
  ...
  <edittypes>
    ...
    <edittype name="plz" type="0" />
    <edittype name="plz6_von" type="0" />
    <edittype name="status" type="0" />
    <edittype name="status_txt" type="0" />
    <edittype name="tid" type="0" />
    <edittype name="zusatzziffern" type="0" />
  </edittypes>
  <editform />
  <editforminit />
  <annotationform />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="plz" fontCapitals="0" fontFamily="Ubuntu" fontItalic="0" fontLetterSpacing="0" fontSize="16" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="0,0,150" textOpacity="1" useSubstitutions="0">
