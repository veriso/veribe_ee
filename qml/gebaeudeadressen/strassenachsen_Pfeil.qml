<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="ordnung" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="Normal" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans Serif" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="170,0,255,255" fontSize="12">
        <families />
      ...
      <placement offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" quadOffset="4" placementFlags="10" fitInPolygonOnly="0" geometryGeneratorEnabled="0" overrunDistance="0" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" preserveRotation="1" repeatDistanceUnits="MM" polygonPlacementFlags="2" overrunDistanceUnit="MM" yOffset="0" dist="0" priority="5" distUnits="MM" placement="2" maxCurvedCharAngleIn="25" repeatDistance="0" geometryGenerator="" xOffset="0" lineAnchorPercent="0.5" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" rotationAngle="0" layerType="UnknownGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" />
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="ordnung">
    ...
    <field configurationFlags="None" name="istachse">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="istachse_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="strassenstueck_von">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="anfangspunkt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="ordnung" expression="" />
    <default applyOnUpdate="0" field="istachse" expression="" />
    <default applyOnUpdate="0" field="istachse_txt" expression="" />
    <default applyOnUpdate="0" field="strassenstueck_von" expression="" />
    <default applyOnUpdate="0" field="anfangspunkt" expression="" />
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" field="ordnung" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="istachse" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="istachse_txt" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="strassenstueck_von" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="anfangspunkt" constraints="0" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="ogc_fid" />
    <constraint exp="" desc="" field="t_ili_tid" />
    <constraint exp="" desc="" field="ordnung" />
    <constraint exp="" desc="" field="istachse" />
    <constraint exp="" desc="" field="istachse_txt" />
    <constraint exp="" desc="" field="strassenstueck_von" />
    <constraint exp="" desc="" field="anfangspunkt" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="ordnung" />
      <column width="-1" hidden="0" type="field" name="istachse" />
      <column width="-1" hidden="0" type="field" name="istachse_txt" />
      <column width="-1" hidden="0" type="field" name="strassenstueck_von" />
      <column width="-1" hidden="0" type="field" name="anfangspunkt" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="anfangspunkt" />
    <field editable="1" name="istachse" />
    <field editable="1" name="istachse_txt" />
    <field editable="1" name="ogc_fid" />
    <field editable="1" name="ordnung" />
    <field editable="1" name="strassenstueck_von" />
    <field editable="1" name="t_ili_tid" />
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="anfangspunkt" />
    <field labelOnTop="0" name="istachse" />
    <field labelOnTop="0" name="istachse_txt" />
    <field labelOnTop="0" name="ogc_fid" />
    <field labelOnTop="0" name="ordnung" />
    <field labelOnTop="0" name="strassenstueck_von" />
