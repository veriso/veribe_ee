<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.7.0-Trunk">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" name="0" outputUnit="MM" type="line">
        <layer class="LineDecoration" locked="0" pass="0">
  ...
  <label>1</label>
  <labelfield>ordnung</labelfield>
  <labelattributes>
    <label fieldname="ordnung" text="Label" />
    ...
    <color blue="255" fieldname="" green="0" red="170" />
    <x fieldname="" />
    <y fieldname="" />
    <offset units="pt" x="0" xfieldname="" y="7" yfieldname="" />
  ...
  <edittypes>
    <edittype name="anfangspunkt" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="istachse" type="0" />
    <edittype name="istachse_txt" type="0" />
    <edittype name="lieferdatum" type="0" />
    <edittype name="los" type="0" />
    <edittype name="ogc_fid" type="0" />
    <edittype name="ordnung" type="0" />
    <edittype name="strassenstueck_von" type="0" />
    <edittype name="t_ili_tid" type="0" />
  </edittypes>
  <editform />
  <editforminit />
  <annotationform />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="ordnung" fontCapitals="0" fontFamily="Sans Serif" fontItalic="0" fontLetterSpacing="0" fontSize="12" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="170,255,0" textOpacity="1" useSubstitutions="0">
