<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol clip_to_extent="1" alpha="0.960784" type="fill" force_rhr="0" name="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="atext" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="Normal" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans Serif" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="222,148,0,255" fontSize="16">
        <families />
        <text-buffer bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferSize="1" bufferNoFill="1" bufferBlendMode="0" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferOpacity="1" />
      ...
      <text-format plussign="0" formatNumbers="0" decimals="3" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" wrapChar="" autoWrapLength="0" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol="&gt;" multilineAlign="4294967295" addDirectionSymbol="0" />
      <placement offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" quadOffset="1" placementFlags="10" fitInPolygonOnly="0" geometryGeneratorEnabled="0" overrunDistance="0" centroidWhole="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" preserveRotation="1" repeatDistanceUnits="MM" polygonPlacementFlags="2" overrunDistanceUnit="MM" yOffset="0" dist="0" priority="5" distUnits="Point" placement="0" maxCurvedCharAngleIn="25" repeatDistance="0" geometryGenerator="" xOffset="0" lineAnchorPercent="0.5" offsetUnits="Point" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" rotationAngle="0" layerType="UnknownGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" />
  ...
  <DiagramLayerSettings obstacle="0" zIndex="0" priority="0" linePlacementFlags="2" dist="0" placement="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value="" />
        <Option name="properties" />
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="kurztext">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="indextext">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="sprache_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    <alias field="atext" name="" index="0" />
    <alias field="kurztext" name="Texte_abrege" index="1" />
    <alias field="indextext" name="Texte_index" index="2" />
    <alias field="sprache_txt" name="Langue_txt" index="3" />
    <alias field="sprache" name="Langue" index="4" />
    <alias field="status" name="Validite" index="5" />
    <alias field="status_txt" name="Validite_txt" index="6" />
    <alias field="ogc_fid" name="" index="7" />
    <alias field="inaenderung_txt" name="En_cours_modification_txt" index="8" />
    <alias field="inaenderung" name="En_cours_modification" index="9" />
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="atext" expression="" />
    <default applyOnUpdate="0" field="kurztext" expression="" />
    <default applyOnUpdate="0" field="indextext" expression="" />
    <default applyOnUpdate="0" field="sprache_txt" expression="" />
    <default applyOnUpdate="0" field="sprache" expression="" />
  ...
  <constraints>
    <constraint unique_strength="0" notnull_strength="0" field="atext" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="kurztext" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="indextext" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="sprache_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="sprache" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="status" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="status_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="1" notnull_strength="1" field="ogc_fid" constraints="3" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="inaenderung_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="inaenderung" constraints="0" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="atext" />
    <constraint exp="" desc="" field="kurztext" />
    <constraint exp="" desc="" field="indextext" />
    <constraint exp="" desc="" field="sprache_txt" />
    <constraint exp="" desc="" field="sprache" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="indextext" />
    <field editable="1" name="kurztext" />
    <field editable="1" name="ogc_fid" />
    <field editable="1" name="sprache" />
    <field editable="1" name="sprache_txt" />
