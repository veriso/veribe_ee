<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      ...
      <symbol alpha="1" name="@0@0" outputUnit="MM" type="marker">
  ...
  <edittypes>
    <edittype name="BAUJAHR" type="0" />
    <edittype name="BESCHRIEB" type="0" />
    <edittype name="BETREIBER" type="0" />
    <edittype name="DESCRIPTIO" type="0" />
    <edittype name="DRUCK" type="0" />
    <edittype name="D_IN_ZOLL" type="0" />
    <edittype name="LAGEGEN" type="0" />
    <edittype name="LAGEGENTYP" type="0" />
    <edittype name="LEITUNG_NR" type="0" />
    <edittype name="NAME" type="0" />
    <edittype name="OBJECTID" type="0" />
    <edittype name="OBJECTID_1" type="0" />
    <edittype name="VERLEGUNG" type="0" />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="BETREIBER" fontCapitals="0" fontFamily="Cantarell" fontItalic="0" fontLetterSpacing="0" fontSize="12" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="0,0,0" textOpacity="1" useSubstitutions="0">
      <text-buffer bufferBlendMode="0" bufferColor="255,255,255" bufferDraw="1" bufferJoinStyle="128" bufferNoFill="1" bufferOpacity="1" bufferSize="2" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="Point" />
