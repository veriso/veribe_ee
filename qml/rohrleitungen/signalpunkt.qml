<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.6">
  <edittypes>
    ...
    <edittype name="punktart" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="punktart_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="betreiber" type="field" width="-1" />
      ...
      <column hidden="0" name="punktart" type="field" width="-1" />
      <column hidden="0" name="punktart_txt" type="field" width="-1" />
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default expression="" field="betreiber" />
    ...
    <default expression="" field="punktart" />
    <default expression="" field="punktart_txt" />
