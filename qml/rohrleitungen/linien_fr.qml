<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 attr="art" enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol" referencescale="-1">
    <categories>
      <category label="Petrole" render="true" symbol="0" value="0" />
      <category label="Gaz" render="true" symbol="1" value="1" />
      <category label="autre" render="true" symbol="2" value="2" />
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol clip_to_extent="1" alpha="1" type="line" force_rhr="0" name="0">
        ...
        <layer enabled="1" locked="0" class="SimpleLine" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0" />
          <prop k="joinstyle" v="bevel" />
          <prop k="line_color" v="45,252,255,255" />
          <prop k="line_style" v="solid" />
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="betreiber" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="Book" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans Serif" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="0,0,0,255" fontSize="18">
        <families />
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="linienart">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="linienart_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="linienart" name="Genre_ligne" index="3" />
    <alias field="linienart_txt" name="Genre_ligne_txt" index="4" />
    <alias field="betreiber" name="Exploitant" index="5" />
    <alias field="qualitaet" name="Qualite" index="6" />
    <alias field="qualitaet_txt" name="Qualite_txt" index="7" />
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="linienart" expression="" />
    <default applyOnUpdate="0" field="linienart_txt" expression="" />
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="linienart" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="linienart_txt" constraints="0" exp_strength="0" />
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="linienart" />
    <constraint exp="" desc="" field="linienart_txt" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="linienart_txt" />
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="linienart_txt" />
