<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="hoehegeom" name="GeomAlt" index="2" />
    <alias field="ori" name="Ori" index="3" />
    <alias field="punktelement_von" name="Element_ponctuel_de" index="4" />
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" field="ori" constraints="1" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="1" field="punktelement_von" constraints="1" exp_strength="0" />
  </constraints>
