<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="art" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Oel" symbol="0" value="0" />
      <category label="Gas" symbol="1" value="1" />
      <category label="weitere" symbol="2" value="2" />
    </categories>
    <symbols>
      <symbol alpha="1" name="0" outputUnit="MM" type="line">
      ...
      <symbol alpha="1" name="1" outputUnit="MM" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          <prop k="capstyle" v="square" />
      ...
      <symbol alpha="1" name="2" outputUnit="MM" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          <prop k="capstyle" v="square" />
  ...
  <edittypes>
    ...
    <edittype name="betreiber" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="lieferdatum" type="0" />
    <edittype name="linienart" type="0" />
    <edittype name="linienart_txt" type="0" />
    <edittype name="linienelement_von" type="0" />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="betreiber" fontCapitals="0" fontFamily="Cantarell" fontItalic="0" fontLetterSpacing="0" fontSize="18" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="0,0,0" textOpacity="1" useSubstitutions="0">
