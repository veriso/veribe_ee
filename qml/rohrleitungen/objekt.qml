<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <labelattributes>
    ...
    <color blue="0" fieldname="" green="85" red="170" />
    <x fieldname="" />
    <y fieldname="" />
  ...
  <edittypes>
    ...
    <edittype name="leitungsobjektpos_von" type="0" />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="betreiber" fontCapitals="0" fontFamily="Cantarell" fontItalic="0" fontLetterSpacing="0" fontSize="11" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="170,0,85" textOpacity="1" useSubstitutions="0">
