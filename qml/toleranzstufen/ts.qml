<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  <transparencyLevelInt>126</transparencyLevelInt>
  <renderer-v2 attr="art" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="TS 1" symbol="0" value="0" />
      <category label="TS 2" symbol="1" value="1" />
      <category label="TS 3" symbol="2" value="2" />
      <category label="TS 4" symbol="3" value="3" />
      <category label="TS 5" symbol="4" value="4" />
      <category label="keine TS zugeordnet!" symbol="5" value="" />
    </categories>
    <symbols>
      <symbol alpha="0.552941" name="0" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="255,85,0,141" />
          <prop k="color_border" v="255,85,0,141" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="1" name="1" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
      ...
      <symbol alpha="1" name="2" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="253,255,114,255" />
      ...
      <symbol alpha="1" name="3" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="115,255,127,255" />
      ...
      <symbol alpha="1" name="4" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="132,160,237,255" />
