<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" labelsEnabled="1" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" maxScale="-4.6566099999999998e-10" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="2" name="Identification" field="identifikator" />
    <alias index="3" name="PrecPlan" field="lagegen" />
    <alias index="4" name="FiabPlan" field="lagezuv" />
    <alias index="5" name="FiabPlan_txt" field="lagezuv_txt" />
    <alias index="6" name="Signe" field="punktzeichen" />
    <alias index="7" name="Signe_txt" field="punktzeichen_txt" />
    <alias index="8" name="Defini_exactement" field="exaktdefiniert" />
    <alias index="9" name="Defini_exactement_txt" field="exaktdefiniert_txt" />
    <alias index="10" name="Anc_borne_speciale" field="hoheitsgrenzsteinalt" />
    <alias index="11" name="Anc_borne_speciale_txt" field="hoheitsgrenzsteinalt_txt" />
    <alias index="12" name="Origine" field="entstehung" />
  </aliases>
  <defaults>
