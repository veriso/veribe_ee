<qgis simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" simplifyDrawingHints="0" labelsEnabled="1" maxScale="0" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <renderer-v2 referencescale="-1" forceraster="0" type="categorizedSymbol" enableorderby="0" attr="art_txt" symbollevels="0">
    <categories>
      <category symbol="0" label="restliche EO-Arten" render="true" value="" />
      <category symbol="1" label="Denkmal" render="true" value="Denkmal" />
      <category symbol="2" label="Quelle" render="true" value="Quelle" />
      <category symbol="3" label="einzelner_Fels" render="true" value="einzelner_Fels" />
      <category symbol="4" label="Mast_Antenne" render="true" value="Mast_Antenne" />
      <category symbol="5" label="Aussichtsturm" render="true" value="Aussichtsturm" />
      <category symbol="6" label="wichtiger_Einzelbaum" render="true" value="wichtiger_Einzelbaum" />
      <category symbol="7" label="Bezugspunkt" render="true" value="Bezugspunkt" />
      <category symbol="8" label="weitere" render="true" value="weitere" />
    </categories>
    <symbols>
