<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" labelsEnabled="1" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1">
  ...
  <fieldConfiguration>
    ...
    <field name="hoheitsgrenzstein" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
    ...
    <field name="hoheitsgrenzstein_txt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias index="8" name="Borne_territoriale" field="hoheitsgrenzstein" />
    <alias index="9" name="Borne_territoriale_txt" field="hoheitsgrenzstein_txt" />
    <alias index="10" name="Defini_exactement" field="exaktdefiniert" />
    <alias index="11" name="Defini_exactement_txt" field="exaktdefiniert_txt" />
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="hoheitsgrenzstein" />
    <default expression="" applyOnUpdate="0" field="hoheitsgrenzstein_txt" />
  ...
  <constraints>
    ...
    <constraint constraints="1" exp_strength="0" field="hoheitsgrenzstein" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" exp_strength="0" field="hoheitsgrenzstein_txt" notnull_strength="1" unique_strength="0" />
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="hoheitsgrenzstein" />
    <constraint exp="" desc="" field="hoheitsgrenzstein_txt" />
