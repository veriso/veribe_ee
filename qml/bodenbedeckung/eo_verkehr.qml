<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category label="eingedoltes_oeffentliches_Gewaesser" symbol="1" value="eingedoltes_oeffentliches_Gewaesser" />
      <category label="Tunnel_Unterfuehrung_Galerie" symbol="2" value="Tunnel_Unterfuehrung_Galerie" />
    </categories>
    <symbols>
      ...
      <symbol alpha="1" name="@1@0" outputUnit="MM" type="line">
