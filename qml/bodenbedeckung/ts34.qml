<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.7.0-Trunk">
    ...
    <symbols>
      <symbol alpha="1" name="0" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="222,223,142,255" />
  ...
  <displayfield>bb_ogc_fid</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype name="bb_art" type="0" />
    <edittype name="bb_art_txt" type="0" />
    <edittype name="bb_geometrie" type="0" />
    <edittype name="bb_ogc_fid" type="0" />
    <edittype name="bb_tid" type="0" />
    <edittype name="entstehung" type="0" />
    <edittype name="flaeche" type="0" />
    ...
    <edittype name="ts_art" type="0" />
    <edittype name="ts_art_txt" type="0" />
  </edittypes>
  <editform />
  <editforminit />
  <annotationform />
