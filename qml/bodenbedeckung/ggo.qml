<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" version="1.7.0-Wroclaw">
  ...
  <singlesymbol>
    <symbol>
      ...
      <uppervalue />
      <label />
      <pointsymbol>svg:/symbol/poi_cave.svg</pointsymbol>
      ...
      <fillcolor blue="11" green="34" red="91" />
  ...
  <edittypes>
    <edittype name="BEM_ALLG" type="0" />
    <edittype name="BEM_FL" type="0" />
    <edittype name="BEM_VERZ" type="0" />
    <edittype name="BESCHL_ART" type="0" />
    <edittype name="BESCHL_DAT" type="0" />
    <edittype name="BESCHL_NR" type="0" />
    <edittype name="GESTEIN" type="0" />
    <edittype name="HERKUNFT" type="0" />
    <edittype name="NAME" type="0" />
    <edittype name="NUMMER" type="0" />
    <edittype name="OBJECTID" type="0" />
    <edittype name="PETRO_STRA" type="0" />
    <edittype name="XKOOR" type="0" />
    <edittype name="YKOOR" type="0" />
