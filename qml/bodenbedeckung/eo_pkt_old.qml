<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="-4.65661e-10" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category label="einzelner_Fels" render="true" symbol="3" value="einzelner_Fels" />
      <category label="Mast_Antenne" render="true" symbol="4" value="Mast_Antenne" />
      <category label="Aussichtsturm" render="true" symbol="5" value="Aussichtsturm" />
      <category label="wichtiger_Einzelbaum" render="true" symbol="6" value="wichtiger_Einzelbaum" />
      <category label="Bezugspunkt" render="true" symbol="7" value="Bezugspunkt" />
      <category label="weitere" render="true" symbol="8" value="weitere" />
    </categories>
    <symbols>
      ...
      <symbol alpha="1" name="6" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
          <prop k="color" v="#000000" />
          <prop k="horizontal_anchor_point" v="1" />
      ...
      <symbol alpha="1" name="7" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
          <prop k="color" v="#000000" />
          <prop k="horizontal_anchor_point" v="1" />
      ...
      <symbol alpha="1" name="8" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
