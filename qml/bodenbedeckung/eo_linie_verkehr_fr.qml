<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="-4.65661e-10" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Ru" render="true" symbol="0" value="Rinnsal" />
      <category label="sentier" render="true" symbol="1" value="schmaler_Weg" />
      <category label="escalier_important" render="true" symbol="2" value="wichtige_Treppe" />
      <category label="eau_canalisee_souterraine" render="true" symbol="3" value="eingedoltes_oeffentliches_Gewaesser" />
      <category label="tunnel_passage_inferieur_galerie" render="true" symbol="4" value="Tunnel_Unterfuehrung_Galerie" />
      <category label="pont_passerelle" render="true" symbol="5" value="Bruecke_Passerelle" />
    </categories>
    <symbols>
