<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="10000" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="1" version="1.7.0-Wroclaw">
  ...
  <singlesymbol>
    <symbol>
      ...
      <symbolfieldname />
      <outlinecolor blue="0" green="170" red="0" />
      <outlinestyle>SolidLine</outlinestyle>
      <outlinewidth>1</outlinewidth>
      <fillcolor blue="4" green="162" red="223" />
  ...
  <edittypes>
    ...
    <edittype name="ART_BEM" type="0" />
    <edittype name="BEMERK" type="0" />
    <edittype name="BESCHL_ART" type="0" />
    <edittype name="BESCHL_DAT" type="0" />
    <edittype name="BESCHL_NR" type="0" />
    <edittype name="NAME" type="0" />
    <edittype name="NUMMER" type="0" />
    <edittype name="OBJECTID" type="0" />
    <edittype name="SCHUTZ" type="0" />
    <edittype name="SHAPE_AREA" type="0" />
    <edittype name="SHAPE_LEN" type="0" />
    <edittype name="TYP" type="0" />
    <edittype name="XKOORD" type="0" />
    <edittype name="YKOORD" type="0" />
    <edittype name="ZUSNUMMER" type="0" />
