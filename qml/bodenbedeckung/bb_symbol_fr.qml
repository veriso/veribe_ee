...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Białowieża" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory minScaleDenominator="inf" opacity="1" barWidth="5" showAxis="0" backgroundColor="#ffffff" penWidth="0" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" minimumSize="0" sizeScale="3x:0,0,0,0,0,0" enabled="0" height="15" spacingUnitScale="3x:0,0,0,0,0,0" spacing="0" direction="1" backgroundAlpha="255" labelPlacementMethod="XHeight" penAlpha="255" sizeType="MM" rotationOffset="270" width="15" maxScaleDenominator="1e+08" lineSizeType="MM" spacingUnit="MM" scaleBasedVisibility="0" scaleDependency="Area" penColor="#000000">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="boflaechesymbol_von">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="altori">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="boflaechesymbol_von" name="" index="1"/>
    <alias field="ori" name="" index="2"/>
    <alias field="altori" name="" index="3"/>
    <alias field="art" name="" index="4"/>
    <alias field="art_txt" name="" index="5"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="ogc_fid" expression=""/>
    <default applyOnUpdate="0" field="boflaechesymbol_von" expression=""/>
    <default applyOnUpdate="0" field="ori" expression=""/>
    <default applyOnUpdate="0" field="altori" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="boflaechesymbol_von" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="ori" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="altori" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="boflaechesymbol_von"/>
    <constraint exp="" desc="" field="ori"/>
    <constraint exp="" desc="" field="altori"/>
