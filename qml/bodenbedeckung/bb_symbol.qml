...
<qgis version="2.18.6" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="boflaechesymbol_von">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="ori">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="altori">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="art_txt" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="befestigt.Wasserbecken" label="befestigt.Wasserbecken"/>
      <category render="true" symbol="1" value="Gewaesser.fliessendes" label="Gewaesser.fliessendes"/>
      <category render="true" symbol="2" value="Gewaesser.stehendes" label="Gewaesser.stehendes"/>
      <category render="true" symbol="3" value="" label="ungültiger Wert"/>
      <category render="true" symbol="4" value="Gewaesser.Schilfguertel" label="Gewaesser.Schilfguertel"/>
      <category render="true" symbol="5" value="humusiert.Intensivkultur.Reben" label="humusiert.Intensivkultur.Reben"/>
    </categories>
    <symbols>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="boflaechesymbol_von" expression=""/>
    <default field="ori" expression=""/>
    <default field="altori" expression=""/>
