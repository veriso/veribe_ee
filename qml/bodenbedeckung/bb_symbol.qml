<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.6">
  <edittypes>
    ...
    <edittype name="boflaechesymbol_von" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="ori" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="altori" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
  ...
  <renderer-v2 attr="art_txt" enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="befestigt.Wasserbecken" render="true" symbol="0" value="befestigt.Wasserbecken" />
      <category label="Gewaesser.fliessendes" render="true" symbol="1" value="Gewaesser.fliessendes" />
      <category label="Gewaesser.stehendes" render="true" symbol="2" value="Gewaesser.stehendes" />
      <category label="ung&#252;ltiger Wert" render="true" symbol="3" value="" />
      <category label="Gewaesser.Schilfguertel" render="true" symbol="4" value="Gewaesser.Schilfguertel" />
      <category label="humusiert.Intensivkultur.Reben" render="true" symbol="5" value="humusiert.Intensivkultur.Reben" />
    </categories>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="boflaechesymbol_von" index="1" name="" />
    <alias field="ori" index="2" name="" />
    <alias field="altori" index="3" name="" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="boflaechesymbol_von" type="field" width="-1" />
      <column hidden="0" name="ori" type="field" width="-1" />
      <column hidden="0" name="altori" type="field" width="-1" />
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default expression="" field="boflaechesymbol_von" />
    <default expression="" field="ori" />
    <default expression="" field="altori" />
