<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" version="1.7.0-Wroclaw">
  <transparencyLevelInt>145</transparencyLevelInt>
  <singlesymbol>
    <symbol>
      <lowervalue />
      <uppervalue />
      ...
      <outlinewidth>0.56</outlinewidth>
  ...
  <customproperties />
  <displayfield>JAHR</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype name="AREN" type="0" />
    <edittype name="BAEUME" type="0" />
