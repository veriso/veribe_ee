<qgis labelsEnabled="1" simplifyDrawingHints="1" maxScale="-4.6566099999999998e-10" minScale="100000000" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" symbologyReferenceScale="-1" readOnly="0" simplifyDrawingTol="1" version="3.22.10-Bia&#322;owie&#380;a">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0">
    <rules key="{fc91a1f0-73e7-4f5b-8fc8-7d766cb80a5f}">
      <rule label="Gebaeude" key="{a19d3f03-72af-4ab5-ba11-3fa28c288fe6}" filter=" &quot;art_txt&quot; LIKE  'Gebaeude%' " symbol="0" />
      <rule label="befestigt.Strasse_Weg" key="{a400d7c0-f1d1-4099-9e46-288c19c99a50}" filter=" &quot;art_txt&quot;  LIKE  'befestigt.Strasse_Weg%' " symbol="1" />
      <rule label="befestigt.Trottoir" key="{a4922fe5-67b5-4f44-9a4e-5285edd97a7d}" filter=" &quot;art_txt&quot;  LIKE  'befestigt.Trottoir%' " symbol="2" />
      <rule label="befestigt.uebrige_befestigte" key="{c99e3b87-3b0b-4461-92d7-6041c8b34d2b}" filter=" &quot;art_txt&quot; LIKE 'befestigt.uebrige_befestigte%' " symbol="3" />
    </rules>
    <symbols>
      ...
      <symbol type="fill" alpha="1" clip_to_extent="1" name="1" force_rhr="0">
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" />
            <Option type="QString" value="191,191,191,255" name="color" />
            <Option type="QString" value="bevel" name="joinstyle" />
            <Option type="QString" value="0,0" name="offset" />
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" />
            <Option type="QString" value="MM" name="offset_unit" />
  ...
  <constraints>
    ...
    <constraint field="art" exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" />
    <constraint field="art_txt" exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1" />
