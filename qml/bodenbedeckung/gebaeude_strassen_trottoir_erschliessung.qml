<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="-4.65661e-10" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;art_txt&quot; LIKE  'Gebaeude%' " label="Gebaeude" symbol="0" />
      <rule filter=" &quot;art_txt&quot;  LIKE  'befestigt.Strasse_Weg%' " label="befestigt.Strasse_Weg" symbol="1" />
      <rule filter=" &quot;art_txt&quot;  LIKE  'befestigt.Trottoir%' " label="befestigt.Trottoir" symbol="2" />
      <rule filter=" &quot;art_txt&quot; LIKE 'befestigt.uebrige_befestigte%' " label="befestigt.uebrige_befestigte" symbol="3" />
    </rules>
    <symbols>
