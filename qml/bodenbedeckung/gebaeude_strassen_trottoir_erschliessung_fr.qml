<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.22.10-Bia&#322;owie&#380;a" simplifyDrawingTol="1" maxScale="-4.6566099999999998e-10" labelsEnabled="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{fc91a1f0-73e7-4f5b-8fc8-7d766cb80a5f}">
      <rule label="batiment" key="{a19d3f03-72af-4ab5-ba11-3fa28c288fe6}" filter=" &quot;art_txt&quot; LIKE  'Gebaeude%' " symbol="0" />
      <rule label="revetement_dur.route_chemin" key="{a400d7c0-f1d1-4099-9e46-288c19c99a50}" filter=" &quot;art_txt&quot;  LIKE  'befestigt.Strasse_Weg%' " symbol="1" />
      <rule label="revetement_dur.trottoir" key="{a4922fe5-67b5-4f44-9a4e-5285edd97a7d}" filter=" &quot;art_txt&quot;  LIKE  'befestigt.Trottoir%' " symbol="2" />
      <rule label="revetement_dur.autre_revetement_dur" key="{c99e3b87-3b0b-4461-92d7-6041c8b34d2b}" filter=" &quot;art_txt&quot; LIKE 'befestigt.uebrige_befestigte%' " symbol="3" />
    </rules>
    <symbols>
      ...
      <symbol type="fill" name="1" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" />
            <Option type="QString" name="color" value="191,191,191,255" />
            <Option type="QString" name="joinstyle" value="bevel" />
            <Option type="QString" name="offset" value="0,0" />
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" />
            <Option type="QString" name="offset_unit" value="MM" />
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" useSubstitutions="0" fontWeight="50" allowHtml="0" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" multilineHeight="1" textOrientation="horizontal" fontSizeUnit="Point" fontKerning="1" fieldName="" fontFamily="Sans Serif" previewBkgrdColor="255,255,255,255" legendString="Aa" namedStyle="Book" fontLetterSpacing="0" textColor="0,0,0,255" blendMode="0" fontStrikeout="0" isExpression="0" textOpacity="1" capitalization="0" fontSize="12">
        <families />
      ...
      <rendering minFeatureSize="0" fontMinPixelSize="3" obstacleFactor="1" mergeLines="0" upsidedownLabels="0" scaleVisibility="0" unplacedVisibility="0" drawLabels="1" fontMaxPixelSize="10000" scaleMax="0" scaleMin="0" zIndex="0" displayAll="1" obstacleType="0" obstacle="1" limitNumLabels="0" fontLimitPixelSize="0" maxNumLabels="2000" labelPerPart="0" />
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value="" />
          <Option name="properties" />
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="labeling/fontBold" value="true" />
      <Option type="QString" name="labeling/fontCapitals" value="0" />
      <Option type="QString" name="labeling/fontFamily" value="Ubuntu" />
      <Option type="QString" name="labeling/fontItalic" value="true" />
      ...
      <Option type="QString" name="labeling/namedStyle" value="Bold Italic" />
  ...
  <defaults>
    ...
    <default expression="" field="qualitaet" applyOnUpdate="0" />
    <default expression="" field="qualitaet_txt" applyOnUpdate="0" />
  ...
  <constraints>
    ...
    <constraint constraints="1" field="qualitaet" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" field="qualitaet_txt" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" field="art" exp_strength="0" notnull_strength="1" unique_strength="0" />
    <constraint constraints="1" field="art_txt" exp_strength="0" notnull_strength="1" unique_strength="0" />
