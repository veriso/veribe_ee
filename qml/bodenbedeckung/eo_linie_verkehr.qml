<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="-4.65661e-10" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
    ...
    <edittype name="ctid" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
  </edittypes>
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Rinnsal" render="true" symbol="0" value="Rinnsal" />
      <category label="schmaler_Weg" render="true" symbol="1" value="schmaler_Weg" />
      <category label="wichtige_Treppe" render="true" symbol="2" value="wichtige_Treppe" />
      <category label="eingedoltes_oeffentliches_Gewaesser" render="true" symbol="3" value="eingedoltes_oeffentliches_Gewaesser" />
      <category label="Tunnel_Unterfuehrung_Galerie" render="true" symbol="4" value="Tunnel_Unterfuehrung_Galerie" />
      <category label="Bruecke_Passerelle" render="true" symbol="5" value="Bruecke_Passerelle" />
    </categories>
    <symbols>
