<qgis simplifyDrawingTol="1" minScale="100000000" simplifyMaxScale="1" simplifyDrawingHints="1" labelsEnabled="1" maxScale="-4.6566099999999998e-10" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" simplifyLocal="1">
  <flags>
  ...
  <renderer-v2 referencescale="-1" forceraster="0" type="categorizedSymbol" enableorderby="0" attr="art_txt" symbollevels="0">
    <categories>
      <category symbol="0" label="Rinnsal" render="true" value="Rinnsal" />
      <category symbol="1" label="schmaler_Weg" render="true" value="schmaler_Weg" />
      <category symbol="2" label="wichtige_Treppe" render="true" value="wichtige_Treppe" />
      <category symbol="3" label="eingedoltes_oeffentliches_Gewaesser" render="true" value="eingedoltes_oeffentliches_Gewaesser" />
      <category symbol="4" label="Tunnel_Unterfuehrung_Galerie" render="true" value="Tunnel_Unterfuehrung_Galerie" />
      <category symbol="5" label="Bruecke_Passerelle" render="true" value="Bruecke_Passerelle" />
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="line" name="5" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="1" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="20,50,50,255" />
            <Option type="QString" name="line_style" value="solid" />
        ...
        <layer enabled="1" pass="16" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" name="draw_inside_polygon" value="0" />
            <Option type="QString" name="joinstyle" value="round" />
            <Option type="QString" name="line_color" value="10,45,170,255" />
            <Option type="QString" name="line_style" value="solid" />
  ...
  <fieldConfiguration>
    ...
    <field name="ctid" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    <alias index="0" name="Entstehung" field="entstehung" />
  ...
  <constraints>
    <constraint constraints="0" field="entstehung" unique_strength="0" notnull_strength="0" exp_strength="0" />
    ...
    <constraint constraints="3" field="ctid" unique_strength="1" notnull_strength="1" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="ctid" exp="" />
  </constraintExpressions>
  <expressionfields />
  <attributeactions />
