<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="befestigt.Bahn" symbol="0" value="befestigt.Bahn" />
      <category label="befestigt.Strasse_Weg" symbol="1" value="befestigt.Strasse_Weg" />
      <category label="befestigt.Trottoir" symbol="2" value="befestigt.Trottoir" />
      <category label="befestigt.Verkehrsinsel" symbol="3" value="befestigt.Verkehrsinsel" />
    </categories>
    <symbols>
      <symbol alpha="0.498039" name="0" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="255,0,127,127" />
          <prop k="color_border" v="255,0,127,127" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="0.494118" name="2" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="170,0,127,126" />
          <prop k="color_border" v="170,0,127,126" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="0.494118" name="3" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="85,170,127,126" />
          <prop k="color_border" v="85,170,127,126" />
          <prop k="offset" v="0,0" />
          <prop k="style" v="solid" />
          <prop k="style_border" v="solid" />
          <prop k="width_border" v="0.26" />
