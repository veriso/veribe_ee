<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Gewaesser.fliessendes" symbol="0" value="Gewaesser.fliessendes" />
      <category label="Gewaesser.stehendes" symbol="1" value="Gewaesser.stehendes" />
      <category label="Gewaesser.Schilfguertel" symbol="2" value="Gewaesser.Schilfguertel" />
    </categories>
    <symbols>
      ...
      <symbol alpha="1" name="1" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          ...
          <prop k="color_border" v="103,102,255,255" />
          <prop k="offset" v="0,0" />
          <prop k="style" v="solid" />
          <prop k="style_border" v="solid" />
          <prop k="width_border" v="0.26" />
      ...
      <symbol alpha="1" name="2" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          ...
          <prop k="color_border" v="85,170,127,255" />
          <prop k="offset" v="0,0" />
