<qgis version="3.4.4-Madeira" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" maxScale="0" readOnly="0" minScale="1e+8" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyLocal="1">
 ...
 <renderer-v2 symbollevels="0" attr="art_txt" enableorderby="0" type="categorizedSymbol" forceraster="0">
  <categories>
   <category symbol="0" label="Voie ferree" render="true" value="Bahngeleise" />
   <category symbol="1" label="Fontaine" render="true" value="Brunnen" />
   <category symbol="2" label="Conduite forcee" render="true" value="Druckleitung" />
   ...
   <category symbol="12" label="Telepherique de chantier" render="true" value="Materialseilbahn" />
   ...
   <category symbol="33" label="Ouvrage de protection des rives" render="true" value="Uferverbauung" />
   <category symbol="34" label="batiment_souterrain" render="true" value="unterirdisches_Gebaeude" />
   <category symbol="35" label="Couvert independant" render="true" value="Unterstand" />
 ...
 <aliases>
  ...
  <alias index="2" field="linienelement_von" name="Element_lineaire_de" />
  <alias index="3" field="art" name="Genre" />
  <alias index="4" field="art_txt" name="Genre_txt" />
  <alias index="5" field="qualitaet_txt" name="Qualite_txt" />
 </aliases>
