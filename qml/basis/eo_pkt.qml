<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category label="Mast Antenne" render="true" symbol="4" value="Mast_Antenne" />
      <category label="Aussichtsturm" render="true" symbol="5" value="Aussichtsturm" />
      <category label="Wichtiger Einzelbaum" render="true" symbol="6" value="wichtiger_Einzelbaum" />
