<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    <alias field="nummer" name="Numero" index="0" />
    <alias field="gesamteflaechenmass" name="Superficie_totale" index="1" />
    <alias field="art_txt" name="Genre_txt" index="2" />
    <alias field="art" name="Genre" index="3" />
    <alias field="vollstaendigkeit_txt" name="Integralite_txt" index="4" />
    <alias field="vollstaendigkeit" name="Integralite" index="5" />
    <alias field="gueltigkeit_txt" name="Validite_txt" index="6" />
    <alias field="gueltigkeit" name="Validite" index="7" />
