<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="-4.65661e-10" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
    ...
    <edittype name="projliegenschaft_von" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
  ...
  <renderer-v2 attr="qualitaet_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category label="PN_def_anerkannt" render="true" symbol="2" value="PN.PN_def_anerkannt" />
      <category label="PN_prov_anerkannt" render="true" symbol="3" value="PN.PN_prov_anerkannt" />
      <category label="PEP" render="true" symbol="4" value="PEP" />
      <category label="weitere" render="true" symbol="5" value="" />
    </categories>
    <symbols>
