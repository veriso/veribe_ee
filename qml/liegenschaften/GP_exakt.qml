...
<qgis labelsEnabled="0" simplifyDrawingHints="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.4-Madeira" maxScale="0" minScale="1e+8" readOnly="0">
  ...
  <symbols>
   <symbol alpha="1" name="0" type="marker" clip_to_extent="1" force_rhr="0">
    <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
     ...
     <prop k="outline_color" v="56,58,184,255"/>
 ...
 <fieldConfiguration>
  ...
  <field name="hoheitsgrenzstein_txt">
   <editWidget type="TextEdit">
    <config>
     <Option/>
    </config>
 ...
 <aliases>
  ...
  <alias field="identifikator" name="" index="2"/>
  <alias field="lagegen" name="" index="3"/>
  <alias field="lagezuv" name="" index="4"/>
  <alias field="lagezuv_txt" name="" index="5"/>
  <alias field="punktzeichen" name="" index="6"/>
  <alias field="punktzeichen_txt" name="" index="7"/>
  <alias field="hoheitsgrenzstein" name="" index="8"/>
  <alias field="hoheitsgrenzstein_txt" name="" index="9"/>
  <alias field="exaktdefiniert" name="" index="10"/>
  <alias field="exaktdefiniert_txt" name="" index="11"/>
  <alias field="entstehung" name="" index="12"/>
 </aliases>
 ...
 <constraints>
  ...
  <constraint field="lagegen" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="lagezuv" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="lagezuv_txt" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="punktzeichen" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="punktzeichen_txt" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="hoheitsgrenzstein" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="hoheitsgrenzstein_txt" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="exaktdefiniert" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
  <constraint field="exaktdefiniert_txt" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
 ...
 <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
  <columns>
   ...
   <column name="hoheitsgrenzstein" type="field" width="-1" hidden="0"/>
   <column name="hoheitsgrenzstein_txt" type="field" width="-1" hidden="0"/>
