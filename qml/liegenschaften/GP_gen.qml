<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
    ...
    <edittype name="identifikator" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    ...
    <edittype name="exaktdefiniert" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="exaktdefiniert_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="hoheitsgrenzsteinalt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="hoheitsgrenzsteinalt_txt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
  </edittypes>
  <renderer-v2 attr="lagegen" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range label="bis 5cm" lower="0.000000" render="true" symbol="0" upper="5.100000" />
      <range label="5 bis 7" lower="5.100000" render="true" symbol="1" upper="7.100000" />
      <range label="7 bis 15" lower="7.100000" render="true" symbol="2" upper="15.100000" />
      <range label="15 bis 35" lower="15.100000" render="true" symbol="3" upper="35.100000" />
      <range label="35 bis 64" lower="35.100000" render="true" symbol="4" upper="64.000000" />
      <range label="64 Plus" lower="64.000000" render="true" symbol="5" upper="1000.000000" />
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" name="2" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="3" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="4" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
      ...
      <symbol alpha="1" name="5" type="marker">
        <layer class="SimpleMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
    ...
    <labelformat decimalplaces="4" format=" %1 - %2 " trimtrailingzeroes="false" />
  </renderer-v2>
  <customproperties>
