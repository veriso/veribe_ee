<qgis maxScale="0" labelsEnabled="1" simplifyMaxScale="1" symbologyReferenceScale="-1" minScale="100000000" readOnly="0" simplifyDrawingTol="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" version="3.22.10-Bia&#322;owie&#380;a" simplifyLocal="1" simplifyAlgorithm="0">
  <flags>
  ...
  <temporal mode="0" enabled="0" startField="" startExpression="" durationField="" accumulate="0" endField="" endExpression="" durationUnit="min" limitMode="0" fixedDuration="0">
    <fixedRange>
      <start />
      <end />
    </fixedRange>
  </temporal>
  <renderer-v2 type="graduatedSymbol" symbollevels="0" referencescale="-1" attr="lagegen" graduatedMethod="GraduatedColor" forceraster="0" enableorderby="0">
    <ranges>
      <range render="true" lower="0.000000000000000" symbol="0" label="bis 5cm" upper="5.100000000000000" />
      <range render="true" lower="5.100000000000000" symbol="1" label="5 bis 7" upper="7.100000000000000" />
      <range render="true" lower="7.100000000000000" symbol="2" label="7 bis 15" upper="15.100000000000000" />
      <range render="true" lower="15.100000000000000" symbol="3" label="15 bis 35" upper="35.100000000000001" />
      <range render="true" lower="35.100000000000001" symbol="4" label="35 bis 64" upper="64.000000000000000" />
      <range render="true" lower="64.000000000000000" symbol="5" label="64 Plus" upper="1000.000000000000000" />
    </ranges>
    <symbols>
      <symbol force_rhr="0" type="marker" name="0" clip_to_extent="1" alpha="1">
        ...
        <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="255,255,127,255" />
      ...
      <symbol force_rhr="0" type="marker" name="1" clip_to_extent="1" alpha="1">
        ...
        <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0" />
            <Option type="QString" name="cap_style" value="square" />
            <Option type="QString" name="color" value="170,255,255,255" />
            <Option type="QString" name="horizontal_anchor_point" value="1" />
            <Option type="QString" name="joinstyle" value="bevel" />
            <Option type="QString" name="name" value="circle" />
            <Option type="QString" name="offset" value="0,0" />
      ...
      <symbol force_rhr="0" type="marker" name="3" clip_to_extent="1" alpha="1">
        ...
        <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0" />
            <Option type="QString" name="cap_style" value="square" />
            <Option type="QString" name="color" value="255,85,127,255" />
            <Option type="QString" name="horizontal_anchor_point" value="1" />
            <Option type="QString" name="joinstyle" value="bevel" />
            <Option type="QString" name="name" value="circle" />
            <Option type="QString" name="offset" value="0,0" />
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontFamily="Sans Serif" previewBkgrdColor="255,255,255,255" namedStyle="Book" allowHtml="0" fontLetterSpacing="0" fontItalic="0" fontStrikeout="0" textOpacity="1" isExpression="0" textColor="0,0,0,255" fontUnderline="0" fontKerning="1" capitalization="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="12" multilineHeight="1" legendString="Aa" fontWordSpacing="0" blendMode="0" fieldName="" useSubstitutions="0" fontWeight="50" textOrientation="horizontal">
        <families />
        <text-buffer bufferDraw="1" bufferOpacity="1" bufferSizeUnits="Point" bufferColor="255,255,255,255" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferBlendMode="0" bufferSize="1" bufferNoFill="1" />
        <text-mask maskSizeUnits="MM" maskJoinStyle="128" maskSize="0" maskOpacity="1" maskType="0" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" />
        <background shapeOffsetY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeJoinStyle="64" shapeDraw="0" shapeRadiiUnit="MM" shapeSizeUnit="MM" shapeSizeType="0" shapeRadiiX="0" shapeBlendMode="0" shapeType="0" shapeOpacity="1" shapeSVGFile="" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeSizeX="0" shapeBorderWidth="0" shapeOffsetUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeRotationType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeRotation="0" shapeBorderColor="128,128,128,255">
        ...
        <shadow shadowRadiusUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.69999999999999996" shadowBlendMode="6" shadowOffsetGlobal="1" shadowDraw="0" shadowScale="100" shadowUnder="0" shadowOffsetAngle="135" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowColor="0,0,0,255" />
        <dd_properties>
          <Option type="Map">
            <Option type="QString" name="name" value="" />
            <Option name="properties" />
      ...
      <text-format useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" placeDirectionSymbol="0" multilineAlign="3" decimals="3" leftDirectionSymbol="&lt;" autoWrapLength="0" plussign="0" wrapChar="" addDirectionSymbol="0" rightDirectionSymbol="&gt;" formatNumbers="0" />
      <placement xOffset="0" polygonPlacementFlags="2" lineAnchorType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" offsetUnits="MM" priority="5" repeatDistanceUnits="MM" dist="0" centroidWhole="0" repeatDistance="0" geometryGenerator="" offsetType="0" distUnits="MM" maxCurvedCharAngleOut="-25" placementFlags="10" yOffset="0" preserveRotation="1" lineAnchorClipping="0" layerType="UnknownGeometry" placement="1" overrunDistance="0" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" geometryGeneratorEnabled="0" centroidInside="0" />
      <rendering zIndex="0" displayAll="1" upsidedownLabels="0" maxNumLabels="2000" scaleMin="0" minFeatureSize="0" drawLabels="1" limitNumLabels="0" fontMaxPixelSize="10000" fontMinPixelSize="3" scaleMax="0" scaleVisibility="0" obstacle="1" mergeLines="0" obstacleType="0" obstacleFactor="1" fontLimitPixelSize="0" unplacedVisibility="0" labelPerPart="0" />
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value="" />
          <Option name="properties" />
  ...
  <aliases>
    ...
    <alias name="Identifikator" field="identifikator" index="2" />
    <alias name="LageGen" field="lagegen" index="3" />
    <alias name="LageZuv" field="lagezuv" index="4" />
    <alias name="LageZuv_txt" field="lagezuv_txt" index="5" />
    <alias name="Punktzeichen" field="punktzeichen" index="6" />
    <alias name="Punktzeichen_txt" field="punktzeichen_txt" index="7" />
    <alias name="ExaktDefiniert" field="exaktdefiniert" index="8" />
    <alias name="ExaktDefiniert_txt" field="exaktdefiniert_txt" index="9" />
    <alias name="HoheitsgrenzsteinAlt" field="hoheitsgrenzsteinalt" index="10" />
    <alias name="HoheitsgrenzsteinAlt_txt" field="hoheitsgrenzsteinalt_txt" index="11" />
    <alias name="Entstehung" field="entstehung" index="12" />
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="lagezuv_txt" expression="" />
    <default applyOnUpdate="0" field="punktzeichen" expression="" />
    <default applyOnUpdate="0" field="punktzeichen_txt" expression="" />
    <default applyOnUpdate="0" field="exaktdefiniert" expression="" />
    <default applyOnUpdate="0" field="exaktdefiniert_txt" expression="" />
    <default applyOnUpdate="0" field="hoheitsgrenzsteinalt" expression="" />
    <default applyOnUpdate="0" field="hoheitsgrenzsteinalt_txt" expression="" />
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0" field="identifikator" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="lagegen" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="lagezuv" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="lagezuv_txt" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="punktzeichen" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="punktzeichen_txt" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="exaktdefiniert" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="exaktdefiniert_txt" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="hoheitsgrenzsteinalt" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="hoheitsgrenzsteinalt_txt" />
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="entstehung" />
  </constraints>
