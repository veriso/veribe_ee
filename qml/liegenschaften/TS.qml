<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.7.0-Trunk">
  <transparencyLevelInt>255</transparencyLevelInt>
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="TS2" symbol="0" value="TS2" />
      <category label="TS3" symbol="1" value="TS3" />
      <category label="TS1" symbol="2" value="TS1" />
      <category label="TS4" symbol="3" value="TS4" />
      <category label="TS5" symbol="4" value="TS5" />
    </categories>
    <symbols>
      <symbol alpha="0.2901960784313726" name="0" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="255,170,127,74" />
          <prop k="color_border" v="0,0,0,74" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="0.2901960784313726" name="1" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="61,183,89,74" />
          <prop k="color_border" v="0,0,0,74" />
          <prop k="offset" v="0,0" />
          <prop k="style" v="solid" />
          <prop k="style_border" v="solid" />
      ...
      <symbol alpha="0.2980392156862745" name="2" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="255,0,127,76" />
      ...
      <symbol alpha="0.2980392156862745" name="3" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="0,255,0,76" />
          <prop k="color_border" v="0,0,0,76" />
          <prop k="offset" v="0,0" />
          <prop k="style" v="solid" />
          <prop k="style_border" v="solid" />
      ...
      <symbol alpha="0.2901960784313726" name="4" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          <prop k="color" v="109,146,128,74" />
          <prop k="color_border" v="0,0,0,74" />
          <prop k="offset" v="0,0" />
          <prop k="style" v="solid" />
          <prop k="style_border" v="solid" />
    ...
    <source-symbol>
      <symbol alpha="1" name="0" outputUnit="MM" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
  ...
  <label>1</label>
  <labelfield>art_txt</labelfield>
  <labelattributes>
    <label fieldname="art_txt" text="Beschriftung" />
    ...
    <color blue="127" fieldname="" green="0" red="255" />
    <x fieldname="" />
    <y fieldname="" />
  ...
  <edittypes>
    <edittype name="art" type="0" />
    <edittype name="art_txt" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="gueltigereintrag" type="0" />
    <edittype name="identifikator" type="0" />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="art_txt" fontCapitals="0" fontFamily="Ubuntu" fontItalic="0" fontLetterSpacing="0" fontSize="12" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="255,127,0" textOpacity="1" useSubstitutions="0">
