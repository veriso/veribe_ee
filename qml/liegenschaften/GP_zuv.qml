<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.7.0-Trunk">
  ...
  <renderer-v2 attr="lagezuv" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="zuverl&#228;ssig" symbol="0" value="0" />
      <category label="unzuverl&#228;ssig" symbol="1" value="1" />
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype name="exaktdefiniert" type="0" />
    <edittype name="exaktdefiniert_txt" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="hoheitsgrenzsteinalt" type="0" />
    <edittype name="hoheitsgrenzsteinalt_txt" type="0" />
