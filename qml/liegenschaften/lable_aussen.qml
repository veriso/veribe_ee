<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol clip_to_extent="1" alpha="0.709804" type="marker" force_rhr="0" name="0">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="lin">
      <editWidget type="Range">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="nbident" name="NBIdent" index="1" />
    <alias field="nummer" name="Nummer" index="2" />
    <alias field="egris_egrid" name="EGRIS_EGRID" index="3" />
    <alias field="gueltigkeit" name="Gueltigkeit" index="4" />
    <alias field="gueltigkeit_txt" name="Gueltigkeit_txt" index="5" />
    <alias field="vollstaendigkeit" name="Vollstaendigkeit" index="6" />
    <alias field="vollstaendigkeit_txt" name="Vollstaendigkeit_txt" index="7" />
    <alias field="art" name="Art" index="8" />
    <alias field="art_txt" name="Art_txt" index="9" />
    <alias field="gesamteflaechenmass" name="GesamteFlaechenmass" index="10" />
    <alias field="gem_bfs" name="" index="11" />
    <alias field="los" name="" index="12" />
    <alias field="lieferdatum" name="" index="13" />
    <alias field="nummerteilgrundstueck" name="NummerTeilGrundstueck" index="14" />
    <alias field="lin" name="" index="15" />
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="lin" constraints="0" exp_strength="0" />
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="lieferdatum" />
      <column width="-1" hidden="0" type="field" name="nummerteilgrundstueck" />
      <column width="-1" hidden="0" type="field" name="lin" />
