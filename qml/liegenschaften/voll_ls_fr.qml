<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="nbident" name="IdentDN" index="3" />
    <alias field="nummer" name="Numero" index="4" />
    <alias field="egris_egrid" name="EGRIS_EGRID" index="5" />
    <alias field="gueltigkeit" name="Validite" index="6" />
    <alias field="gueltigkeit_txt" name="Validite_txt" index="7" />
    <alias field="vollstaendigkeit" name="Integralite" index="8" />
    <alias field="vollstaendigkeit_txt" name="Integralite_txt" index="9" />
    <alias field="art" name="Genre" index="10" />
    <alias field="art_txt" name="Genre_txt" index="11" />
    <alias field="gesamteflaechenmass" name="Superficie_totale" index="12" />
    <alias field="flaechenmass" name="Superficie" index="13" />
