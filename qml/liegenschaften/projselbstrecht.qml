...
<qgis labelsEnabled="0" simplifyDrawingHints="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.4-Madeira" maxScale="0" minScale="1e+8" readOnly="0">
 ...
 <fieldConfiguration>
  ...
  <field name="projselbstrecht_von">
   <editWidget type="TextEdit">
    <config>
     <Option/>
    </config>
 ...
 <aliases>
  ...
  <alias field="projselbstrecht_von" name="" index="6"/>
 </aliases>
 ...
 <constraints>
  ...
  <constraint field="projselbstrecht_von" unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1"/>
 </constraints>
 ...
 <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
  <columns>
   ...
   <column name="projselbstrecht_von" type="field" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
 ...
 <editable>
  ...
  <field editable="1" name="projselbstrecht_von"/>
