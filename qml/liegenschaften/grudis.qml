<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="0.227451" name="0" type="fill">
  ...
  <attributeactions>
    <actionsetting action="https://www.grudis.apps.be.ch/grudis/capweb/faces?type=grundstueck_uebersicht&amp;egrid=[% &quot;egris_egrid&quot; %]" capture="0" icon="" name="Websuche nach dem Attributwert durchf&#252;hren" type="5" />
  </attributeactions>
