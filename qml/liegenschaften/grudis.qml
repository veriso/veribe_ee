...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Białowieża" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="entstehung" name="" index="2"/>
    <alias field="nbident" name="" index="3"/>
    <alias field="nummer" name="" index="4"/>
    <alias field="egris_egrid" name="" index="5"/>
    <alias field="gueltigkeit" name="" index="6"/>
    <alias field="gueltigkeit_txt" name="" index="7"/>
    <alias field="vollstaendigkeit" name="" index="8"/>
    <alias field="vollstaendigkeit_txt" name="" index="9"/>
    <alias field="art" name="" index="10"/>
    <alias field="art_txt" name="" index="11"/>
    <alias field="gesamteflaechenmass" name="" index="12"/>
    <alias field="flaechenmass" name="" index="13"/>
    <alias field="nummerteilgrundstueck" name="" index="14"/>
  </aliases>
  <defaults>
