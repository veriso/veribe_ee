<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol clip_to_extent="1" alpha="0.227451" type="fill" force_rhr="0" name="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="nummer" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="Book" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans Serif" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="0,0,0,255" fontSize="12">
        <families />
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="labeling/fieldName" value="nummer" />
      ...
      <Option type="QString" name="labeling/fontSize" value="10" />
      ...
      <Option type="QString" name="labeling/priority" value="10" />
      ...
      <Option type="QString" name="labeling/scaleMax" value="20000" />
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="egris_egrid">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="gueltigkeit">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="gueltigkeit_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="vollstaendigkeit">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="vollstaendigkeit_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="gesamteflaechenmass">
  ...
  <aliases>
    ...
    <alias field="entstehung" name="Entstehung" index="2" />
    <alias field="nbident" name="NBIdent" index="3" />
    <alias field="nummer" name="Nummer" index="4" />
    <alias field="egris_egrid" name="EGRIS_EGRID" index="5" />
    <alias field="gueltigkeit" name="Gueltigkeit" index="6" />
    <alias field="gueltigkeit_txt" name="Gueltigkeit_txt" index="7" />
    <alias field="vollstaendigkeit" name="Vollstaendigkeit" index="8" />
    <alias field="vollstaendigkeit_txt" name="Vollstaendigkeit_txt" index="9" />
    <alias field="art" name="Art" index="10" />
    <alias field="art_txt" name="Art_txt" index="11" />
    <alias field="gesamteflaechenmass" name="GesamteFlaechenmass" index="12" />
    <alias field="flaechenmass" name="Flaechenmass" index="13" />
    <alias field="nummerteilgrundstueck" name="NummerTeilGrundstueck" index="14" />
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="nbident" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="nummer" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="egris_egrid" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="gueltigkeit" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="gueltigkeit_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="vollstaendigkeit" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="vollstaendigkeit_txt" constraints="0" exp_strength="0" />
    ...
    <constraint unique_strength="0" notnull_strength="0" field="gesamteflaechenmass" constraints="0" exp_strength="0" />
  ...
  <attributeactions>
    ...
    <actionsetting capture="0" shortTitle="" icon="" notificationMessage="" isEnabledOnlyWhenEditable="0" type="5" name="Websuche nach dem Attributwert durchf&#252;hren" action="https://www.grudis.apps.be.ch/grudis/capweb/faces?type=grundstueck_uebersicht&amp;egrid=[% &quot;egris_egrid&quot; %]" id="{d7336768-93e6-4126-9372-8848018eff38}">
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="egris_egrid" />
      <column width="-1" hidden="0" type="field" name="gueltigkeit" />
      <column width="-1" hidden="0" type="field" name="gueltigkeit_txt" />
      <column width="-1" hidden="0" type="field" name="vollstaendigkeit" />
      <column width="-1" hidden="0" type="field" name="vollstaendigkeit_txt" />
      <column width="-1" hidden="0" type="field" name="art" />
      <column width="-1" hidden="0" type="field" name="art_txt" />
      <column width="-1" hidden="0" type="field" name="gesamteflaechenmass" />
      <column width="-1" hidden="0" type="field" name="flaechenmass" />
      <column width="-1" hidden="0" type="field" name="nummerteilgrundstueck" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="gesamteflaechenmass" />
    <field editable="1" name="gueltigkeit" />
    <field editable="1" name="gueltigkeit_txt" />
    <field editable="1" name="nbident" />
    <field editable="1" name="nummer" />
    <field editable="1" name="nummerteilgrundstueck" />
    <field editable="1" name="ogc_fid" />
    <field editable="1" name="t_ili_tid" />
    <field editable="1" name="vollstaendigkeit" />
    <field editable="1" name="vollstaendigkeit_txt" />
  </editable>
  <labelOnTop>
