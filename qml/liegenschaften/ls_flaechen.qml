<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
    ...
    <edittype name="liegenschaft_von" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="nummerteilgrundstueck" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="flaechenmass" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="flaeche" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{2cdbefb9-b625-48d7-bf4b-3e45fd704aeb}">
      <rule filter="qualitaet_txt = 'AV93' and (( $area -0.55&gt;&quot;flaechenmass&quot; ) or ( $area +0.55&lt; &quot;flaechenmass&quot; ) )" key="{0029f964-6608-478a-8284-7c0964a0e7c6}" label="AV93 / MO93" symbol="0" />
      <rule filter="qualitaet_txt &lt;&gt; 'AV93' and (( $area -0.55&gt; &quot;flaechenmass&quot; ) or ( $area +0.55&lt; &quot;flaechenmass&quot; ) )" key="{12bb080d-e08d-44b2-a172-424a8f28755b}" label="andere Qualit&#228;t / autres de qualit&#233;" symbol="1" />
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="fill">
        <layer class="LinePatternFill" locked="0" pass="0">
          ...
          <symbol alpha="1" name="@0@0" type="line">
  ...
  <label>0</label>
  <labelfield>flaeche</labelfield>
  <labelattributes>
    <label fieldname="flaeche" text="Beschriftung" />
    ...
    <color blue="0" fieldname="" green="0" red="255" />
    <x fieldname="" />
    <y fieldname="" />
...
<labeling type="simple">
  <settings>
    <text-style blendMode="0" fieldName="flaeche" fontCapitals="0" fontFamily="Ubuntu" fontItalic="0" fontLetterSpacing="0" fontSize="12" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" isExpression="0" multilineHeight="1" namedStyle="Book" previewBkgrdColor="#ffffff" textColor="255,0,0" textOpacity="1" useSubstitutions="0">
