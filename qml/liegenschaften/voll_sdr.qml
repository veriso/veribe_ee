<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 attr="vollstaendigkeit_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Vollstaendig" symbol="0" value="Vollstaendig" />
      <category label="unvollstaendig" symbol="1" value="unvollstaendig" />
      <category label="anderes Attribut" symbol="2" value="" />
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype name="flaechenmass" type="0" />
