<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" labelsEnabled="1" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1">
  ...
  <aliases>
    <alias index="0" name="Numero" field="nummer" />
    <alias index="1" name="Superficie_totale" field="gesamteflaechenmass" />
    <alias index="2" name="Genre_txt" field="art_txt" />
    <alias index="3" name="Genre" field="art" />
    <alias index="4" name="Integralite_txt" field="vollstaendigkeit_txt" />
    <alias index="5" name="Integralite" field="vollstaendigkeit" />
    <alias index="6" name="Validite_txt" field="gueltigkeit_txt" />
    <alias index="7" name="Validite" field="gueltigkeit" />
