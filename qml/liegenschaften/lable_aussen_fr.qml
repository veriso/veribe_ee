<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    ...
    <alias field="nbident" name="IdentDN" index="1" />
    <alias field="nummer" name="Numero" index="2" />
    <alias field="egris_egrid" name="EGRIS_EGRID" index="3" />
    <alias field="gueltigkeit" name="Validite" index="4" />
    <alias field="gueltigkeit_txt" name="Validite_txt" index="5" />
    <alias field="vollstaendigkeit" name="Integralite" index="6" />
    <alias field="vollstaendigkeit_txt" name="Integralite_txt" index="7" />
    <alias field="art" name="Genre" index="8" />
    <alias field="art_txt" name="Genre_txt" index="9" />
    <alias field="gesamteflaechenmass" name="Superficie_totale" index="10" />
    <alias field="gem_bfs" name="" index="11" />
    <alias field="los" name="" index="12" />
    <alias field="lieferdatum" name="" index="13" />
    <alias field="nummerteilgrundstueck" name="PartieNumeroImmeuble" index="14" />
