<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    <alias field="nummer" name="Nummer" index="0" />
    <alias field="gesamteflaechenmass" name="GesamteFlaechenmass" index="1" />
    <alias field="art_txt" name="Art_txt" index="2" />
    <alias field="art" name="Art" index="3" />
    <alias field="vollstaendigkeit_txt" name="Vollstaendigkeit_txt" index="4" />
    <alias field="vollstaendigkeit" name="Vollstaendigkeit" index="5" />
    <alias field="gueltigkeit_txt" name="Gueltigkeit_txt" index="6" />
    <alias field="gueltigkeit" name="Gueltigkeit" index="7" />
    <alias field="egris_egrid" name="EGRIS_EGRID" index="8" />
    <alias field="ogc_fid" name="" index="9" />
  </aliases>
  <defaults>
