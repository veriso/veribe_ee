...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Białowieża" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <aliases>
    <alias field="nummer" name="" index="0"/>
    <alias field="gesamteflaechenmass" name="" index="1"/>
    <alias field="art_txt" name="" index="2"/>
    <alias field="art" name="" index="3"/>
    <alias field="vollstaendigkeit_txt" name="" index="4"/>
    <alias field="vollstaendigkeit" name="" index="5"/>
    <alias field="gueltigkeit_txt" name="" index="6"/>
    <alias field="gueltigkeit" name="" index="7"/>
    <alias field="egris_egrid" name="" index="8"/>
