<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.7.0-Trunk">
  ...
  <edittypes>
    ...
    <edittype name="egris_egrid" type="0" />
    <edittype name="gem_bfs" type="0" />
    <edittype name="gesamteflaechenmass" type="0" />
    <edittype name="gueltigkeit" type="0" />
    <edittype name="gueltigkeit_txt" type="0" />
    <edittype name="lieferdatum" type="0" />
    <edittype name="los" type="0" />
    <edittype name="nummer" type="0" />
    <edittype name="ogc_fid" type="0" />
    <edittype name="vollstaendigkeit" type="0" />
    <edittype name="vollstaendigkeit_txt" type="0" />
  </edittypes>
  <editform />
  <editforminit />
  <annotationform />
