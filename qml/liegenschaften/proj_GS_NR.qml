<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" labelsEnabled="1" version="3.22.10-Bia&#322;owie&#380;a" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1">
  ...
  <aliases>
    <alias index="0" name="Nummer" field="nummer" />
    <alias index="1" name="GesamteFlaechenmass" field="gesamteflaechenmass" />
    <alias index="2" name="Art_txt" field="art_txt" />
    <alias index="3" name="Art" field="art" />
    <alias index="4" name="Vollstaendigkeit_txt" field="vollstaendigkeit_txt" />
    <alias index="5" name="Vollstaendigkeit" field="vollstaendigkeit" />
    <alias index="6" name="Gueltigkeit_txt" field="gueltigkeit_txt" />
    <alias index="7" name="Gueltigkeit" field="gueltigkeit" />
    <alias index="8" name="EGRIS_EGRID" field="egris_egrid" />
    <alias index="9" name="" field="ogc_fid" />
  </aliases>
  <defaults>
