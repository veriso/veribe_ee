...
<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" labelsEnabled="1" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1">
  ...
  <aliases>
    <alias index="0" name="" field="nummer"/>
    <alias index="1" name="" field="gesamteflaechenmass"/>
    <alias index="2" name="" field="art_txt"/>
    <alias index="3" name="" field="art"/>
    <alias index="4" name="" field="vollstaendigkeit_txt"/>
    <alias index="5" name="" field="vollstaendigkeit"/>
    <alias index="6" name="" field="gueltigkeit_txt"/>
    <alias index="7" name="" field="gueltigkeit"/>
    <alias index="8" name="" field="egris_egrid"/>
