...
<qgis minScale="1e+08" maxScale="1000" hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" opacity="0.5" type="singlebandpseudocolor" alphaBand="-1" classificationMax="14" band="1" classificationMin="14">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader labelPrecision="6" colorRampType="EXACT" clip="0" minimumValue="14" maximumValue="14" classificationMode="1">
          ...
          <item alpha="255" label="Gewaesser" color="#b5c0f1" value="14"/>
