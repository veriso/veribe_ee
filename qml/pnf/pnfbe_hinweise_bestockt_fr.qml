...
<qgis hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" maxScale="1000" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" alphaBand="-1" classificationMin="17" classificationMax="17" opacity="0.5" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="EXACT" minimumValue="17" classificationMode="1" clip="0" maximumValue="17" labelPrecision="6">
          ...
          <item alpha="255" label="boisee" value="17" color="#07a644"/>
