<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.6">
  <edittypes>
    ...
    <edittype name="X_COORD" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="Y_COORD" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="FLUGDATUM" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="FLUGDAT_2" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="GEOPNAME" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="ID_KACHEL" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          ...
          <prop k="color" v="118,219,109,255" />
  ...
  <displayfield>GEOPNAME</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="X_COORD" index="1" name="" />
    <alias field="Y_COORD" index="2" name="" />
    <alias field="FLUGDATUM" index="3" name="" />
    <alias field="FLUGDAT_2" index="4" name="" />
    <alias field="GEOPNAME" index="5" name="" />
    <alias field="ID_KACHEL" index="6" name="" />
    <alias field="SHAPE_AREA" index="7" name="" />
    <alias field="SHAPE_LEN" index="8" name="" />
  </aliases>
  <excludeAttributesWMS />
  <excludeAttributesWFS />
  <attributeactions default="-1" />
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="105236704">
    <columns>
      <column hidden="0" name="OBJECTID" type="field" width="-1" />
      <column hidden="0" name="X_COORD" type="field" width="-1" />
      <column hidden="0" name="Y_COORD" type="field" width="-1" />
      <column hidden="0" name="FLUGDATUM" type="field" width="-1" />
      <column hidden="0" name="FLUGDAT_2" type="field" width="-1" />
      <column hidden="0" name="GEOPNAME" type="field" width="-1" />
      <column hidden="0" name="ID_KACHEL" type="field" width="-1" />
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default expression="" field="X_COORD" />
    <default expression="" field="Y_COORD" />
    <default expression="" field="FLUGDATUM" />
    <default expression="" field="FLUGDAT_2" />
    <default expression="" field="GEOPNAME" />
    <default expression="" field="ID_KACHEL" />
