...
<qgis minScale="1e+08" maxScale="1000" hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" opacity="0.5" type="singlebandpseudocolor" alphaBand="-1" classificationMax="0" band="1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader labelPrecision="6" colorRampType="EXACT" clip="0" minimumValue="0" maximumValue="0" classificationMode="1">
          ...
          <item alpha="255" label="Gebaeude" color="#d7191c" value="0"/>
