...
<qgis hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" maxScale="1000" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" alphaBand="-1" classificationMin="14" classificationMax="14" opacity="0.5" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="EXACT" minimumValue="14" classificationMode="1" clip="0" maximumValue="14" labelPrecision="6">
          ...
          <item alpha="255" label="eau" value="14" color="#b5c0f1"/>
