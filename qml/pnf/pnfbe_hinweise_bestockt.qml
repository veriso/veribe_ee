...
<qgis minScale="1e+08" maxScale="1000" hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" opacity="0.5" type="singlebandpseudocolor" alphaBand="-1" classificationMax="17" band="1" classificationMin="17">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader labelPrecision="6" colorRampType="EXACT" clip="0" minimumValue="17" maximumValue="17" classificationMode="1">
          ...
          <item alpha="255" label="bestockt" color="#07a644" value="17"/>
