<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.11">
  <edittypes>
    <edittype name="FID_Arbeit" widgetv2type="TextEdit">
    ...
    <edittype name="FID_Perime" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="GMDE" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="V_KREISNR" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="NAME" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="Shape_Leng" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="Shape_Area" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="Waldabt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="NFG" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="Erledigt" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
  </edittypes>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="fill">
        <layer class="SimpleFill" locked="0" pass="0">
          ...
          <prop k="color" v="160,226,207,255" />
  ...
  <annotationform />
  <aliases>
    <alias field="FID_Arbeit" index="0" name="" />
    <alias field="Id" index="1" name="" />
    <alias field="FID_Perime" index="2" name="" />
    <alias field="GMDE" index="3" name="" />
    <alias field="V_KREISNR" index="4" name="" />
    <alias field="NAME" index="5" name="" />
    <alias field="Shape_Leng" index="6" name="" />
    <alias field="Shape_Area" index="7" name="" />
    <alias field="Waldabt" index="8" name="" />
    <alias field="NFG" index="9" name="" />
    <alias field="Erledigt" index="10" name="" />
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="FID_Arbeit" type="field" width="-1" />
      <column hidden="0" name="Id" type="field" width="-1" />
      <column hidden="0" name="FID_Perime" type="field" width="-1" />
      <column hidden="0" name="GMDE" type="field" width="-1" />
      <column hidden="0" name="V_KREISNR" type="field" width="-1" />
      <column hidden="0" name="Shape_Leng" type="field" width="-1" />
      <column hidden="0" name="Shape_Area" type="field" width="-1" />
      <column hidden="0" name="Waldabt" type="field" width="-1" />
      <column hidden="0" name="NFG" type="field" width="-1" />
      <column hidden="0" name="Erledigt" type="field" width="-1" />
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default expression="" field="FID_Arbeit" />
    <default expression="" field="Id" />
    <default expression="" field="FID_Perime" />
    <default expression="" field="GMDE" />
    <default expression="" field="V_KREISNR" />
    <default expression="" field="NAME" />
    <default expression="" field="Shape_Leng" />
    <default expression="" field="Shape_Area" />
    <default expression="" field="Waldabt" />
    <default expression="" field="NFG" />
    <default expression="" field="Erledigt" />
  </defaults>
