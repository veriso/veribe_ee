...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" labelsEnabled="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="1" name="" field="top"/>
    <alias index="2" name="" field="right"/>
    <alias index="3" name="" field="bottom"/>
  ...
  <constraints>
    <constraint constraints="0" exp_strength="0" field="left" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="top" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="right" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="bottom" notnull_strength="0" unique_strength="0"/>
