...
<qgis hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" maxScale="1000" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" alphaBand="-1" classificationMin="8" classificationMax="8" opacity="0.5" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="EXACT" minimumValue="8" classificationMode="1" clip="0" maximumValue="8" labelPrecision="6">
          ...
          <item alpha="255" label="ouvert vegetation" value="8" color="#83de99"/>
