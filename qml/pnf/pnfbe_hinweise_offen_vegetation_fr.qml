...
<qgis version="3.6.3-Noosa" maxScale="1000" styleCategories="AllStyleCategories" minScale="1e+8" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    <rasterrenderer type="singlebandpseudocolor" classificationMax="8" band="1" alphaBand="-1" classificationMin="8" opacity="0.5">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="EXACT" classificationMode="1" clip="0">
          ...
          <item alpha="255" color="#83de99" value="8" label="ouvert vegetation"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
