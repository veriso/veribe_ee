<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="0" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.5.0-Master">
  <edittypes>
    <edittype name="id_0" widgetv2type="TextEdit">
    ...
    <edittype name="leitung_nr" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="name" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="betreiber" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    ...
    <edittype name="d_in_zoll" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="druck" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="verlegung" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="objectid_1" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="lagegentyp" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="beschrieb" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
    <edittype name="descriptio" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" fieldEditable="1" labelOnTop="0" />
    </edittype>
  </edittypes>
  <renderer-v2 attr="betreiber" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="GVM" render="true" symbol="0" value="GVM" />
      <category label="SWISSGAS" render="true" symbol="1" value="SWISSGAS" />
      <category label="TRANSITGAS" render="true" symbol="2" value="TRANSITGAS" />
      <category label="UNIGAZ" render="true" symbol="3" value="UNIGAZ" />
      <category label="" render="true" symbol="4" value="" />
    </categories>
    <symbols>
      <symbol alpha="1" name="0" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="line_color" v="145,239,57,255" />
      ...
      <symbol alpha="1" name="1" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0" />
          <prop k="joinstyle" v="bevel" />
          <prop k="line_color" v="237,102,34,255" />
          <prop k="line_style" v="solid" />
          <prop k="line_width" v="1" />
          <prop k="line_width_unit" v="MM" />
          <prop k="offset" v="0" />
      ...
      <symbol alpha="1" name="2" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0" />
          <prop k="joinstyle" v="bevel" />
          <prop k="line_color" v="20,34,232,255" />
          <prop k="line_style" v="solid" />
          <prop k="line_width" v="1" />
          <prop k="line_width_unit" v="MM" />
          <prop k="offset" v="0" />
      ...
      <symbol alpha="1" name="3" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0" />
          <prop k="joinstyle" v="bevel" />
          <prop k="line_color" v="83,205,173,255" />
          <prop k="line_style" v="solid" />
          <prop k="line_width" v="1" />
          <prop k="line_width_unit" v="MM" />
          <prop k="offset" v="0" />
      ...
      <symbol alpha="1" name="4" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0" />
          <prop k="joinstyle" v="bevel" />
          <prop k="line_color" v="209,106,195,255" />
          <prop k="line_style" v="solid" />
    ...
    <source-symbol>
      <symbol alpha="1" name="0" type="line">
        <layer class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0" />
          <prop k="joinstyle" v="bevel" />
          <prop k="line_color" v="122,168,192,255" />
          <prop k="line_style" v="solid" />
