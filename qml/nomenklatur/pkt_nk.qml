...
<qgis labelsEnabled="0" simplifyDrawingHints="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.4-Madeira" maxScale="0" minScale="1e+8" readOnly="0">
 ...
 <renderer-v2 forceraster="0" enableorderby="0" type="singleSymbol" symbollevels="0">
  <symbols>
   <symbol alpha="0.82" name="0" type="marker" clip_to_extent="1" force_rhr="0">
 ...
 <defaults>
  <default field="z_ls_nk_pkt_fid" expression="" applyOnUpdate="0"/>
  <default field="ls_fid" expression="" applyOnUpdate="0"/>
  <default field="nk_fid" expression="" applyOnUpdate="0"/>
  <default field="flaeche" expression="" applyOnUpdate="0"/>
 </defaults>
 <constraints>
  <constraint field="z_ls_nk_pkt_fid" unique_strength="1" exp_strength="0" notnull_strength="1" constraints="3"/>
  <constraint field="ls_fid" unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0"/>
  <constraint field="nk_fid" unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0"/>
  <constraint field="flaeche" unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0"/>
 </constraints>
 <constraintExpressions>
  <constraint field="z_ls_nk_pkt_fid" exp="" desc=""/>
  <constraint field="ls_fid" exp="" desc=""/>
  <constraint field="nk_fid" exp="" desc=""/>
 ...
 <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
  <columns>
   <column name="z_ls_nk_pkt_fid" type="field" width="-1" hidden="0"/>
   <column name="ls_fid" type="field" width="-1" hidden="0"/>
   <column name="nk_fid" type="field" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
 ...
 <labelOnTop>
  ...
  <field name="ls_fid" labelOnTop="0"/>
  <field name="nk_fid" labelOnTop="0"/>
  <field name="z_ls_nk_pkt_fid" labelOnTop="0"/>
 </labelOnTop>
 <widgets/>
