...
<qgis version="3.4.4-Madeira" readOnly="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0">
 ...
 <labeling type="simple">
  <settings>
   <text-style useSubstitutions="0" textColor="255,0,0,255" fontStrikeout="0" multilineHeight="1" fontWordSpacing="0" fontLetterSpacing="0" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fieldName="aname" fontSize="20" fontFamily="Sans Serif" blendMode="0" fontCapitals="0" fontSizeUnit="MapUnit" fontUnderline="0" namedStyle="Normal" fontItalic="0" previewBkgrdColor="#ffffff" textOpacity="1">
   ...
   <text-format rightDirectionSymbol=">" decimals="3" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" multilineAlign="1" wrapChar="" plussign="0" formatNumbers="0" placeDirectionSymbol="0" addDirectionSymbol="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1"/>
   <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" centroidInside="0" repeatDistance="0" maxCurvedCharAngleOut="-25" distUnits="MM" repeatDistanceUnits="MM" offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" centroidWhole="1" preserveRotation="1" xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" priority="5" yOffset="0" quadOffset="4" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MM" rotationAngle="0"/>
   <rendering obstacleFactor="1" maxNumLabels="2000" fontMaxPixelSize="10000" upsidedownLabels="0" zIndex="0" labelPerPart="0" minFeatureSize="0" scaleMin="0" displayAll="0" scaleMax="0" obstacle="1" obstacleType="0" drawLabels="1" mergeLines="0" fontLimitPixelSize="1" scaleVisibility="0" fontMinPixelSize="3" limitNumLabels="0"/>
   <dd_properties>
    <Option type="Map">
     <Option name="name" value="" type="QString"/>
     <Option name="properties"/>
 ...
 <aliases>
  ...
  <alias field="aname" index="2" name=""/>
  <alias field="nbident" index="3" name=""/>
  <alias field="nummer" index="4" name=""/>
  <alias field="entstehung" index="5" name=""/>
 </aliases>
 ...
 <constraints>
  ...
  <constraint field="aname" exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1"/>
 ...
 <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
  <columns>
   ...
   <column width="-1" name="aname" type="field" hidden="0"/>
