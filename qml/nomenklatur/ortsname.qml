...
<qgis version="3.4.4-Madeira" readOnly="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1" maxScale="-4.65661e-10" simplifyMaxScale="1" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0">
 <flags>
 ...
 <labeling type="simple">
  <settings>
   <text-style useSubstitutions="0" textColor="51,160,44,255" fontStrikeout="0" multilineHeight="1" fontWordSpacing="0" fontLetterSpacing="0" fontWeight="75" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fieldName="aname" fontSize="18" fontFamily="DejaVu Sans" blendMode="0" fontCapitals="0" fontSizeUnit="Point" fontUnderline="1" namedStyle="Bold" fontItalic="0" previewBkgrdColor="#ffffff" textOpacity="1">
    <text-buffer bufferDraw="0" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSizeUnits="Point" bufferColor="255,255,255,255" bufferOpacity="1" bufferJoinStyle="128" bufferSize="1"/>
 ...
 <customproperties>
  ...
  <property key="labeling/fontFamily" value="Garuda"/>
 ...
 <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
  <DiagramCategory maxScaleDenominator="1e+8" sizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" enabled="0" width="15" scaleBasedVisibility="0" lineSizeType="MM" rotationOffset="270" backgroundAlpha="255" penColor="#000000" barWidth="5" scaleDependency="Area" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" backgroundColor="#ffffff" minimumSize="0" labelPlacementMethod="XHeight" penAlpha="255" height="15" minScaleDenominator="-4.65661e-10" penWidth="0" opacity="1">
 ...
 <constraints>
  ...
  <constraint field="typ" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
