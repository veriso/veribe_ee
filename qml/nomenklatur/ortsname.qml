<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="-4.6566099999999998e-10" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="aname" fontUnderline="1" allowHtml="0" fontWordSpacing="0" namedStyle="Bold" fontSizeUnit="Point" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="75" fontFamily="DejaVu Sans" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="51,160,44,255" fontSize="18">
        <families />
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="labeling/fontFamily" value="Garuda" />
      ...
      <Option type="QString" name="labeling/fontUnderline" value="true" />
      ...
      <Option type="QString" name="labeling/textColorB" value="44" />
      <Option type="QString" name="labeling/textColorG" value="160" />
      <Option type="QString" name="labeling/textColorR" value="51" />
  ...
  <aliases>
    ...
    <alias field="aname" name="" index="2" />
    <alias field="typ" name="Typ" index="3" />
    <alias field="nbident" name="NBIdent" index="4" />
    <alias field="nummer" name="Nummer" index="5" />
