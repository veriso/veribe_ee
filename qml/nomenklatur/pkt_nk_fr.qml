<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol clip_to_extent="1" alpha="0.82" type="marker" force_rhr="0" name="0">
  ...
  <referencedLayers />
  <fieldConfiguration>
    <field configurationFlags="None" name="z_ls_nk_pkt_fid">
    ...
    <field configurationFlags="None" name="ls_fid">
    ...
    <field configurationFlags="None" name="nk_fid">
      <editWidget type="Range">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    <alias field="z_ls_nk_pkt_fid" name="" index="0" />
    <alias field="ls_fid" name="" index="1" />
    <alias field="nk_fid" name="" index="2" />
    <alias field="flaeche" name="Geometrie" index="3" />
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="z_ls_nk_pkt_fid" expression="" />
    <default applyOnUpdate="0" field="ls_fid" expression="" />
    <default applyOnUpdate="0" field="nk_fid" expression="" />
    <default applyOnUpdate="0" field="flaeche" expression="" />
  </defaults>
  <constraints>
    <constraint unique_strength="1" notnull_strength="1" field="z_ls_nk_pkt_fid" constraints="3" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="ls_fid" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="nk_fid" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="flaeche" constraints="0" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="z_ls_nk_pkt_fid" />
    <constraint exp="" desc="" field="ls_fid" />
    <constraint exp="" desc="" field="nk_fid" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="z_ls_nk_pkt_fid" />
      <column width="-1" hidden="0" type="field" name="ls_fid" />
      <column width="-1" hidden="0" type="field" name="nk_fid" />
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="ls_fid" />
    <field editable="1" name="nk_fid" />
    <field editable="1" name="z_ls_nk_pkt_fid" />
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="flaeche" />
    <field labelOnTop="0" name="ls_fid" />
    <field labelOnTop="0" name="nk_fid" />
    <field labelOnTop="0" name="z_ls_nk_pkt_fid" />
  </labelOnTop>
  <reuseLastValue />
  <dataDefinedFieldProperties />
  <widgets />
  <previewExpression>z_ls_nk_pkt_fid</previewExpression>
  <mapTip />
