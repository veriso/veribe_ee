<qgis simplifyAlgorithm="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" version="3.22.10-Bia&#322;owie&#380;a" maxScale="-4.6566099999999998e-10" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1">
  <flags>
      ...
      <symbol clip_to_extent="1" alpha="1" type="marker" force_rhr="0" name="0">
        ...
        <layer enabled="1" locked="0" class="SimpleMarker" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="208,11,87,255" />
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="aname" fontUnderline="0" allowHtml="0" fontWordSpacing="0" namedStyle="Normal" fontSizeUnit="MapUnit" useSubstitutions="0" fontLetterSpacing="0" multilineHeight="1" blendMode="0" capitalization="0" textOrientation="horizontal" fontWeight="50" fontFamily="Sans Serif" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontItalic="0" fontKerning="1" legendString="Aa" textOpacity="1" textColor="0,0,0,255" fontSize="16">
        <families />
        <text-buffer bufferSizeUnits="Point" bufferColor="255,255,255,255" bufferSize="1" bufferNoFill="1" bufferBlendMode="0" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferOpacity="1" />
      ...
      <text-format plussign="0" formatNumbers="0" decimals="3" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" wrapChar="" autoWrapLength="0" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol="&gt;" multilineAlign="0" addDirectionSymbol="0" />
      <placement offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" quadOffset="4" placementFlags="10" fitInPolygonOnly="0" geometryGeneratorEnabled="0" overrunDistance="0" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" preserveRotation="1" repeatDistanceUnits="MM" polygonPlacementFlags="2" overrunDistanceUnit="MM" yOffset="0" dist="0" priority="5" distUnits="MM" placement="0" maxCurvedCharAngleIn="25" repeatDistance="0" geometryGenerator="" xOffset="0" lineAnchorPercent="0.5" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" rotationAngle="0" layerType="UnknownGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" />
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="labeling/fieldName" value="aname" />
      ...
      <Option type="QString" name="labeling/fontSize" value="16" />
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory minScaleDenominator="-4.65661e-10" opacity="1" barWidth="5" showAxis="0" backgroundColor="#ffffff" penWidth="0" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" minimumSize="0" sizeScale="3x:0,0,0,0,0,0" enabled="0" height="15" spacingUnitScale="3x:0,0,0,0,0,0" spacing="0" direction="1" backgroundAlpha="255" labelPlacementMethod="XHeight" penAlpha="255" sizeType="MM" rotationOffset="270" width="15" maxScaleDenominator="1e+08" lineSizeType="MM" spacingUnit="MM" scaleBasedVisibility="0" scaleDependency="Area" penColor="#000000">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="gelaendenamepos_von">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="ori">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="hali">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="hali_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="vali">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="vali_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="groesse">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="groesse_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="stil">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="stil_txt">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
    ...
    <field configurationFlags="None" name="rot">
      <editWidget type="TextEdit">
        <config>
          <Option />
        </config>
  ...
  <aliases>
    ...
    <alias field="gelaendenamepos_von" name="GelaendenamePos_von" index="2" />
    ...
    <alias field="stil" name="Stil" index="10" />
    <alias field="stil_txt" name="Stil_txt" index="11" />
    <alias field="y" name="" index="12" />
    <alias field="x" name="" index="13" />
    <alias field="rot" name="" index="14" />
    <alias field="aname" name="" index="15" />
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="ogc_fid" expression="" />
    <default applyOnUpdate="0" field="t_ili_tid" expression="" />
    <default applyOnUpdate="0" field="gelaendenamepos_von" expression="" />
    <default applyOnUpdate="0" field="ori" expression="" />
    <default applyOnUpdate="0" field="hali" expression="" />
    <default applyOnUpdate="0" field="hali_txt" expression="" />
    <default applyOnUpdate="0" field="vali" expression="" />
    <default applyOnUpdate="0" field="vali_txt" expression="" />
    <default applyOnUpdate="0" field="groesse" expression="" />
    <default applyOnUpdate="0" field="groesse_txt" expression="" />
    <default applyOnUpdate="0" field="stil" expression="" />
    <default applyOnUpdate="0" field="stil_txt" expression="" />
    <default applyOnUpdate="0" field="y" expression="" />
    <default applyOnUpdate="0" field="x" expression="" />
    <default applyOnUpdate="0" field="rot" expression="" />
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="gelaendenamepos_von" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="ori" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="hali" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="hali_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="vali" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="vali_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="groesse" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="groesse_txt" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="stil" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="stil_txt" constraints="0" exp_strength="0" />
    ...
    <constraint unique_strength="0" notnull_strength="0" field="rot" constraints="0" exp_strength="0" />
    <constraint unique_strength="0" notnull_strength="0" field="aname" constraints="0" exp_strength="0" />
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="ogc_fid" />
    <constraint exp="" desc="" field="t_ili_tid" />
    <constraint exp="" desc="" field="gelaendenamepos_von" />
    ...
    <constraint exp="" desc="" field="stil" />
    <constraint exp="" desc="" field="stil_txt" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="gelaendenamepos_von" />
      <column width="-1" hidden="0" type="field" name="ori" />
      <column width="-1" hidden="0" type="field" name="hali" />
      <column width="-1" hidden="0" type="field" name="hali_txt" />
      <column width="-1" hidden="0" type="field" name="vali" />
      <column width="-1" hidden="0" type="field" name="vali_txt" />
      <column width="-1" hidden="0" type="field" name="groesse" />
      <column width="-1" hidden="0" type="field" name="groesse_txt" />
      <column width="-1" hidden="0" type="field" name="stil" />
      <column width="-1" hidden="0" type="field" name="stil_txt" />
      <column width="-1" hidden="0" type="field" name="y" />
      <column width="-1" hidden="0" type="field" name="x" />
      <column width="-1" hidden="0" type="field" name="rot" />
