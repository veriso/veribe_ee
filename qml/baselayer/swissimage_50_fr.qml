...
<qgis hasScaleBasedVisibilityFlag="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" maxScale="-4.65661e-10" minScale="1e+08">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" alphaBand="0" opacity="0.498039" type="singlebandcolordata">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
