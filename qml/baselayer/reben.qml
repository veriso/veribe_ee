<qgis hasScaleBasedVisibilityFlag="0" maximumScale="1e+08" minimumScale="0" version="1.8.0-Lisboa">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      ...
      <symbol alpha="1" name="@0@0" outputUnit="MM" type="line">
  ...
  <edittypes>
    <edittype name="BRUTTOFLA" type="0" />
    <edittype name="GEOID" type="0" />
    <edittype name="JAHR" type="0" />
    <edittype name="KULTURCODE" type="0" />
    <edittype name="KULTURCO_1" type="0" />
    <edittype name="KU_BEZEI_D" type="0" />
    <edittype name="KU_BEZEI_F" type="0" />
    <edittype name="KU_ZEICH_D" type="0" />
    <edittype name="KU_ZEICH_F" type="0" />
    <edittype name="NETTOFLA" type="0" />
